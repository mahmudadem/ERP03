...
- **Next — epic wrap-up (owner decision on sequencing):**
  1. **Wrap-up docs:** write `docs/architecture/system-core.md` (consolidated), `module-boundaries.md`, `pos-independence.md`; confirm all 10 architecture tests (audit §N) are present + green.
