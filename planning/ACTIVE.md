...
**Status:** 🟡 **Phase 4 in progress (2026-06-21)** — 250k Accounting Bridge hardening is committed; 250l-1 Commercial Core pricing/discount is implemented and green; 250l-2 cost-margin and 250l-3 promotions remain. **Branch:** `feat/system-core-transformation` (worktree `D:\DEV2026\ERP03-system-core`).
...
- **Next:** Commit 250l-1, then execute **250l-2 cost-margin**. 250l remains high risk because it touches posting-sensitive totals; each slice needs focused golden-total regressions and its own commit/report.
