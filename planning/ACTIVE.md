...
**Next step:** Continue Task 132 Phase 5 by shrinking remaining unsafe action-feedback allowlist entries outside the frozen top-bar widget scope. Keep the top-bar widget system frozen.
