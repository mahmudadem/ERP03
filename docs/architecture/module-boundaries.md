...
- **FUP-3:** Sales/Purchases/Inventory posters not yet all routed behind `IAccountingBridge`. Sales DeliveryNote COGS path migrated to bridge-only (Task 267-F, 2026-06-25); SI/SR/Purchases/Inventory still hold a `SubledgerVoucherPostingService` field as fallback.
