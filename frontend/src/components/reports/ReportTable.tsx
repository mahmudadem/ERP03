...
export interface ReportColumnDefinition<T = any>
  extends Omit<ColumnDefinition<T>, 'render' | 'width' | 'priority'> {
  // Report columns size themselves by default; width/priority are optional overrides.
  width?: ColumnDefinition<T>['width'];
  priority?: ColumnDefinition<T>['priority'];
