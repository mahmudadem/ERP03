        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600 mt-1">
              {moduleLabels[moduleCode]} operations will track quantities and documents but will NOT create financial/GL postings.
            </p>
            <button
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2">
              <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-200 text-blue-800">
                Accounting Enabled — Setup Required
              </span>
            </div>
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-green-700 mt-1">
            {moduleLabels[moduleCode]} is fully integrated with Accounting. All operations create financial/GL postings.
          </p>
        </div>
      </div>
    </div>
