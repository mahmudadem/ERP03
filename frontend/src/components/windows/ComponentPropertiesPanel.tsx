  ...
  if (!component) {
    return (
      <div className="text-center text-gray-400 py-10 px-6">
        ...
        <p className="text-sm">{t(`Select a component in the grid to edit its properties.`)}</p>
      </div>
    );
  }
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        {/* Field ID (Read-only) */}
        <div>
          <label className="block text-[10px] font-bold text-gray-400 mb-1 uppercase tracking-widest">{t(`Field ID`)}</label>
        ...
        {/* Custom Label */}
        <div>
          <label className="block text-[10px] font-bold text-gray-400 mb-1 uppercase tracking-widest">{t(`Custom Label`)}</label>
          <input 
            type="text" 
        ...
        {/* Width Slider */}
        <div>
          <label className="block text-[10px] font-bold text-gray-400 mb-1 uppercase tracking-widest">{t(`Width (Columns)`)}</label>
          ...
          <p className="text-[10px] text-gray-400 mt-1 italic font-medium">{t(`Grid has 12 columns total.`)}</p>
        </div>

        {/* Row/Col Position */}
        <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-100">
          <div>
            <label className="block text-[10px] font-bold text-gray-400 mb-1 uppercase tracking-widest">{t(`Row Index`)}</label>
            <input 
              type="number" 
              min="0"
              value={component.row}
          ...
          <div>
            <label className="block text-[10px] font-bold text-gray-400 mb-1 uppercase tracking-widest">{t(`Column Start`)}</label>
            <input 
              type="number" 
              min="0" 
              max="11"
        ...
        {/* Move to Section */}
        <div>
          <label className="block text-[10px] font-bold text-gray-400 mb-1 uppercase tracking-widest">{t(`Move to Section`)}</label>
          <select 
        ...
        <div className="pt-6 border-t border-gray-100">
          <h4 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4">{t(`Appearance`)}</h4>
          <div className="space-y-4">
             {/* Colors */}
             <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[10px] font-medium text-gray-500 mb-1">{t(`Text Color`)}</label>
                  <input
                    type="color"
                ...
                <div>
                  <label className="block text-[10px] font-medium text-gray-500 mb-1">{t(`Background`)}</label>
                  <input
                    type="color"
             ...
             {/* Font Weight */}
             <div>
                <label className="block text-[10px] font-medium text-gray-500 mb-1">{t(`Font Weight`)}</label>
                <select
                ...
                >
                  ...
                  <option value="600">{t(`Semi-Bold`)}</option>
                </select>
             </div>
          </div>
        </div>
