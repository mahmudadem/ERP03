...
export const BaseCurrencyWidget: React.FC<BaseCurrencyWidgetProps> = ({
  ...
  return (
    <div className={clsx(
      ...
      <span className="text-[9px] text-[var(--color-text-secondary)] font-bold uppercase tracking-widest leading-none mb-1">Currency</span>
      <span className="text-[12px] font-black tracking-tight text-[var(--color-text-primary)] leading-none">{company?.baseCurrency || 'NONE'}</span>
    </div>
  );
};
