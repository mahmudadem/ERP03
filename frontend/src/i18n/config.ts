      ...
      en: {
        common: {
          errors: {
            ...
            ACC_004: "The accounting period for this date is closed and cannot be updated.",
            ACC_005: "Invalid account type for this operation.",
            ACC_006: "You do not have permission to use account {{accountName}}.",
            ACC_007: "Account {{accountName}} is currently locked or inactive.",
          ...
          success: {
            ...
            SAVE: "Voucher saved successfully!",
            voucher_submitted: "Voucher submitted for approval!",
            SUBMIT: "Voucher submitted for approval!",
      ...
      ar: {
        common: {
          errors: {
            ...
            ACC_004: "الفترة المحاسبية لهذا التاريخ مغلقة ولا يمكن التعديل عليها.",
            ACC_005: "نوع حساب غير صالح لهذه العملية.",
            ACC_006: "ليس لديك إذن لاستخدام الحساب {{accountName}}.",
            ACC_007: "الحساب {{accountName}} مقفل حالياً أو غير نشط.",
          ...
          success: {
            ...
            SAVE: "تم حفظ القيد بنجاح!",
            voucher_submitted: "تم إرسال القيد للموافقة!",
            SUBMIT: "تم إرسال القيد للموافقة!",
