  ...
  return (
    <div className="space-y-5 font-sans">
      ...
      <div className="flex items-center space-x-2.5">
        ...
        <div>
          <h2 className="text-sm font-bold text-slate-800">إعدادات المحاسبة / Accounting Settings</h2>
        ...
        {SETTINGS_SECTIONS.map((section) => {
          ...
          return (
            ...
            >
              ...
              <h3 className="text-[10px] font-bold text-slate-700 leading-tight">{section.nameAr}</h3>
      ...
      <div className="bg-slate-800 rounded-lg p-4 flex items-center justify-between">
        <div className="text-white">
          <h3 className="text-xs font-bold">Full Accounting Settings</h3>
