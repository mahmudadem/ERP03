          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {personalFields.map(field => (
              ...
              >
                ...
                <button
                  onClick={() => openComponentSelector(field.id)}
                  className="mt-3 w-full flex items-center justify-center gap-2 px-3 py-2 bg-white border-2 border-purple-300 rounded-lg text-purple-700 hover:bg-purple-50 hover:border-purple-400 transition-colors text-sm font-medium"
                >
