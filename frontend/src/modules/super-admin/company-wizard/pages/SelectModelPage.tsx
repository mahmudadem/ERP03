  ...
  return (
    <div className="max-w-2xl mx-auto">
      <Card className="p-6 space-y-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">{t(`Create Company`)}</h1>
          <p className="text-sm text-gray-500">{t(`Select the business model to start the guided setup.`)}</p>
        </div>
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div className="flex flex-col gap-1">
            <label className="text-sm font-medium text-gray-800">{t(`Company Name`)}</label>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-1">
            <label className="text-sm font-medium text-gray-800">{t(`Model`)}</label>
            <select
              className="border rounded px-3 py-2 text-sm"
              value={model}
