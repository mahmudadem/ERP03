            ...
            {list.map((w, idx) => {
              ...
              return (
                <div key={w.id} draggable
                  ...
                  className="flex flex-col justify-center px-2 py-0.5 rounded border border-slate-200/40 dark:border-slate-800/40 bg-slate-50/50 dark:bg-slate-950/40 cursor-grab select-none min-w-[80px]"
                >
            ...
            {list.map((w, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-slate-400 font-bold uppercase text-[9px] mr-0.5">{widgetTypeLabel(w.type)}:</span>
            ...
            {list.map((w, idx) => {
              ...
              return (
                <div key={w.id} draggable
                  ...
                  onDragOver={(e) => handleDragOver(e, idx)}
                  onDragEnd={handleDragEnd}
                  className="flex flex-col px-2.5 py-0.5 border border-dashed border-sky-400/60 bg-sky-50/10 text-sky-400 cursor-grab text-[10px]"
                >
