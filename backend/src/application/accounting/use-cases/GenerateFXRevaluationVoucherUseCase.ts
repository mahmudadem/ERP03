import { FXRevaluationResult } from './CalculateFXRevaluationUseCase';
...
export class GenerateFXRevaluationVoucherUseCase {
  constructor(
  ...
  async execute(
    companyId: string, 
    userId: string, 
    calculationResult: FXRevaluationResult,
    targetGainLossAccountId: string
  ): Promise<any> {
    ...
    const strategy = VoucherPostingStrategyFactory.getStrategy('fx_revaluation');
    ...
    const voucher = new VoucherEntity(
      ...
      VoucherType.FX_REVALUATION, // type
