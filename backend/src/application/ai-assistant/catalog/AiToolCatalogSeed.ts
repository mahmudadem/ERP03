...
const accountingAccountTools: AiToolDefinition[] = [
  ...
  new AiToolDefinition(
    ...
    'accounting', active, read_only,
    ['accounting.reports.generalLedger.view'], ['accounting'],
    { type: 'object', properties: { accountCode: { type: 'string' }, fromDate: { type: 'string', description: 'Start date in YYYY-MM-DD format. Derive from CURRENT DATE in system prompt.' }, toDate: { type: 'string', description: 'End date in YYYY-MM-DD format. Derive from CURRENT DATE in system prompt.' } } },
...
const accountingReportTools: AiToolDefinition[] = [
  ...
  new AiToolDefinition(
    ...
    { type: 'object', properties: { fromDate: { type: 'string', description: 'Start date in YYYY-MM-DD format. Derive from CURRENT DATE in system prompt.' }, toDate: { type: 'string', description: 'End date in YYYY-MM-DD format. Derive from CURRENT DATE in system prompt.' } } },
...
const salesTools: AiToolDefinition[] = [
  ...
  new AiToolDefinition(
    ...
    'sales', active, read_only,
    ['sales.invoices.view'], ['sales'],
    { type: 'object', properties: { limit: { type: 'number', default: 10 }, fromDate: { type: 'string', description: 'Start date in YYYY-MM-DD format. Derive from CURRENT DATE in system prompt.' }, toDate: { type: 'string', description: 'End date in YYYY-MM-DD format. Derive from CURRENT DATE in system prompt.' } } },
...
const authoritativeReportTools: AiToolDefinition[] = [
  ...
  new AiToolDefinition(
    ...
    'reports', active, read_only,
    ['accounting.reports.generalLedger.view'], ['accounting'],
    { type: 'object', properties: { accountCode: { type: 'string', description: 'Account code (required)' }, fromDate: { type: 'string', description: 'Start date in YYYY-MM-DD format. Derive from CURRENT DATE in system prompt.' }, toDate: { type: 'string', description: 'End date in YYYY-MM-DD format. Derive from CURRENT DATE in system prompt.' }, costCenterId: { type: 'string' } }, required: ['accountCode'] },
    { type: 'object', properties: { reportContext: { type: 'object' }, moneyContext: { type: 'object' }, data: { type: 'object' } } },
    true, true, true, R, S_M,
  ),
  new AiToolDefinition(
