...
import { ListCurrenciesUseCase, GetCurrencyUseCase } from '../../../application/core/use-cases/CurrencyUseCases';
import { ListCompanyCurrenciesUseCase, EnableCurrencyForCompanyUseCase, DisableCurrencyForCompanyUseCase } from '../../../application/core/use-cases/CompanyCurrencyUseCases';
import { GetSuggestedRateUseCase, SaveReferenceRateUseCase, DetectRateDeviationService } from '../../../application/core/services/ExchangeRateService';

export class CurrencyCoreController {
  /**
   * GET /currencies
