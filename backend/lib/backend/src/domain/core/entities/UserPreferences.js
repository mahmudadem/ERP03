...
class UserPreferences {
    constructor(userId, language = 'en', uiMode = 'windows', theme = 'light', sidebarMode = 'classic', sidebarPinned = true, appearanceSettings = {}, disabledNotificationCategories = [], notificationCategoryOverrides = {}, createdAt = new Date(), updatedAt = new Date()) {
        this.userId = userId;
