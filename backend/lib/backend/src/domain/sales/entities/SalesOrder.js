...
class SalesOrder {
    constructor(props) {
        ...
        if (!((_a = props.id) === null || _a === void 0 ? void 0 : _a.trim()))
            throw new Error('SalesOrder id is required');
        if (!((_b = props.companyId) === null || _b === void 0 ? void 0 : _b.trim()))
            throw new Error('SalesOrder companyId is required');
        if (!((_c = props.orderNumber) === null || _c === void 0 ? void 0 : _c.trim()))
            throw new Error('SalesOrder orderNumber is required');
        if (!((_d = props.customerId) === null || _d === void 0 ? void 0 : _d.trim()))
            throw new Error('SalesOrder customerId is required');
        if (!((_e = props.currency) === null || _e === void 0 ? void 0 : _e.trim()))
            throw new Error('SalesOrder currency is required');
        if (!((_f = props.createdBy) === null || _f === void 0 ? void 0 : _f.trim()))
            throw new Error('SalesOrder createdBy is required');
    ...
    normalizeLine(line, index) {
        ...
        if (!((_a = line.itemId) === null || _a === void 0 ? void 0 : _a.trim()))
            throw new Error(`SalesOrder line ${index + 1}: itemId is required`);
        ...
        if (!((_b = line.uom) === null || _b === void 0 ? void 0 : _b.trim())) {
            throw new Error(`SalesOrder line ${index + 1}: uom is required`);
        }
        const normalizedTaxRate = (_c = line.taxRate) !== null && _c !== void 0 ? _c : 0;
        ...
        return {
            lineId: line.lineId,
            lineNo: (_d = line.lineNo) !== null && _d !== void 0 ? _d : index + 1,
            itemId: line.itemId,
            ...
            returnedQty: (_g = line.returnedQty) !== null && _g !== void 0 ? _g : 0,
