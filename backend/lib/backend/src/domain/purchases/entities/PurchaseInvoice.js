...
class PurchaseInvoice {
    constructor(props) {
        ...
        if (!((_b = props.companyId) === null || _b === void 0 ? void 0 : _b.trim()))
            throw new Error('PurchaseInvoice companyId is required');
        if (!((_c = props.invoiceNumber) === null || _c === void 0 ? void 0 : _c.trim()))
            throw new Error('PurchaseInvoice invoiceNumber is required');
        if (!((_d = props.vendorId) === null || _d === void 0 ? void 0 : _d.trim()))
            throw new Error('PurchaseInvoice vendorId is required');
        if (!((_e = props.invoiceDate) === null || _e === void 0 ? void 0 : _e.trim()))
            throw new Error('PurchaseInvoice invoiceDate is required');
        if (!((_f = props.currency) === null || _f === void 0 ? void 0 : _f.trim()))
            throw new Error('PurchaseInvoice currency is required');
        if (!((_g = props.createdBy) === null || _g === void 0 ? void 0 : _g.trim()))
            throw new Error('PurchaseInvoice createdBy is required');
    ...
    normalizeLine(line, index) {
        ...
        if (!((_a = line.lineId) === null || _a === void 0 ? void 0 : _a.trim()))
            throw new Error(`PurchaseInvoice line ${index + 1}: lineId is required`);
        if (!((_b = line.itemId) === null || _b === void 0 ? void 0 : _b.trim()))
            throw new Error(`PurchaseInvoice line ${index + 1}: itemId is required`);
        ...
        if (!((_c = line.uom) === null || _c === void 0 ? void 0 : _c.trim()))
            throw new Error(`PurchaseInvoice line ${index + 1}: uom is required`);
