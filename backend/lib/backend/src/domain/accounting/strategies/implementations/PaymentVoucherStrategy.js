...
class PaymentVoucherStrategy {
    async generateLines(header, companyId, baseCurrency) {
        ...
        const canonicalLines = (allocations || []).filter((line) => {
        ...
        for (let i = 0; i < allocations.length; i++) {
            ...
            const debitLine = new VoucherLineEntity_1.VoucherLineEntity(i + 1, payToAccountId, 'Debit', amountBase, // baseAmount
            normalizedBaseCurrency, // baseCurrency
            amountFx, // amount
            lineCurrency, // currency
            absoluteRate, allocation.notes || allocation.description || 'Payment allocation', allocation.costCenterId || allocation.costCenter, allocation.metadata || {});
        ...
        const creditCurrency = ((_a = lines[0]) === null || _a === void 0 ? void 0 : _a.currency) || headerCurrency;
        const creditRate = creditCurrency === normalizedBaseCurrency
            ? 1
            : (creditCurrency === headerCurrency ? headerRate : Number(((_b = lines[0]) === null || _b === void 0 ? void 0 : _b.exchangeRate) || headerRate || 1));
        ...
        creditRate, header.description || 'Payment from account', undefined, {});
