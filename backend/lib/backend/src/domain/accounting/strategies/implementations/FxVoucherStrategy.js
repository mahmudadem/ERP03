...
exports.FxVoucherStrategy = void 0;
const VoucherLine_1 = require("../../entities/VoucherLine");
const crypto_1 = require("crypto");
class FxVoucherStrategy {
    async generateLines(header, companyId) {
        ...
        const buyLine = new VoucherLine_1.VoucherLine((0, crypto_1.randomUUID)(), '', header.buyAccountId, header.description || 'FX Buy');
        ...
        const sellLine = new VoucherLine_1.VoucherLine((0, crypto_1.randomUUID)(), '', header.sellAccountId, header.description || 'FX Sell');
        sellLine.debitFx = 0;
...
exports.FxVoucherStrategy = FxVoucherStrategy;
//# sourceMappingURL=FxVoucherStrategy.js.map