...
class OnboardingController {
    ...
    static async listBundles(req, res, next) {
        try {
            const bundles = await bindRepositories_1.diContainer.bundleRegistryRepository.getReady();
            // Format for frontend
    ...
    static async createCompany(req, res, next) {
        ...
        try {
            ...
            const useCase = new CreateCompanyUseCase_1.CreateCompanyUseCase(bindRepositories_1.diContainer.companyRepository, bindRepositories_1.diContainer.userRepository, bindRepositories_1.diContainer.rbacCompanyUserRepository, bindRepositories_1.diContainer.companyRoleRepository, resolver, bindRepositories_1.diContainer.bundleRegistryRepository, bindRepositories_1.diContainer.bundleRegistryRepository, bindRepositories_1.diContainer.companyModuleRepository, bindRepositories_1.diContainer.companySettingsRepository, bindRepositories_1.diContainer.companyEntitlementRepository);
            const result = await useCase.execute({
                userId,
                companyName,
                description,
