...
if (process.env.FUNCTIONS_EMULATOR || process.env.FIREBASE_AUTH_EMULATOR_HOST) {
    ...
    (_c = process.env).FIREBASE_DATABASE_EMULATOR_HOST || (_c.FIREBASE_DATABASE_EMULATOR_HOST = '127.0.0.1:9000');
...
if (!firebase_admin_1.default.apps.length) {
    firebase_admin_1.default.initializeApp({ projectId, storageBucket, databaseURL });
}
