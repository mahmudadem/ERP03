...
exports.PrismaGoodsReceiptRepository = void 0;
const GoodsReceipt_1 = require("../../../../domain/purchases/entities/GoodsReceipt");
class PrismaGoodsReceiptRepository {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async create(grn, _transaction) {
    ...
    toDomain(record) {
        ...
        return GoodsReceipt_1.GoodsReceipt.fromJSON({
            id: record.id,
