...
async function main() {
    ...
    const accounts = accountSnap.docs.map(d => (Object.assign({ id: d.id }, d.data())));
    ...
    const contraAccount = accounts.find(a => a.id !== targetAccount.id &&
...
//# sourceMappingURL=seedPerformanceData.js.map