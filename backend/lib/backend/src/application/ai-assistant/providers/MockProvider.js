...
class MockProvider {
    constructor() {
        ...
        this.providerName = 'Mock AI Provider';
    }
    getCapabilities() {
        return Object.assign({}, MockProvider.CAPABILITIES);
    }
    async chat(request) {
        var _a, _b;
        ...
        const lastUserMessage = request.messages
            ...
            .pop();
        const userContent = (lastUserMessage === null || lastUserMessage === void 0 ? void 0 : lastUserMessage.content) || 'Hello';
        ...
        return {
            ...
            metadata: {
                ...
                toolsProvided: (_b = (_a = request.tools) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0,
...
MockProvider.MOCK_SYSTEM_PREFIX = '[Mock AI Assistant — this is a simulated response for development. ' +
    'No real AI is being used.]\n\n';
MockProvider.SAFETY_SUFFIX = '\n\n---\n*Note: The AI Assistant is advisory-only and cannot create, ' +
