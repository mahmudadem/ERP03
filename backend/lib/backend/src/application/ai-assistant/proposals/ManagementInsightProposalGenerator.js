...
exports.ManagementInsightProposalGenerator = void 0;
const AiProposalGenerator_1 = require("./AiProposalGenerator");
class ManagementInsightProposalGenerator extends AiProposalGenerator_1.AiProposalGenerator {
    constructor() {
        super(...arguments);
        this.proposalType = 'reports.managementInsightProposal';
    ...
    generateInsights(toolData) {
        ...
        if (data.agingReceivables) {
            const aging = data.agingReceivables;
        ...
        if (data.agingPayables) {
            const aging = data.agingPayables;
            if (aging.over90Days > 0) {
                insights.push({
                    category: 'payables',
...
exports.ManagementInsightProposalGenerator = ManagementInsightProposalGenerator;
//# sourceMappingURL=ManagementInsightProposalGenerator.js.map