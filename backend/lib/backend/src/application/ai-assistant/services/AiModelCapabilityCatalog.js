...
class AiModelCapabilityCatalog {
    /**
     ...
     */
    static getProfile(provider, modelName) {
        ...
        for (const rule of PATTERN_RULES) {
            if (modelCandidates.some(candidate => rule.pattern.test(candidate))) {
                ...
                return {
                    provider: normalizedProvider,
                    modelName: modelName || '',
                    status: (_j = base.status) !== null && _j !== void 0 ? _j : 'tested',
                    supportsToolCalling: (_k = base.supportsToolCalling) !== null && _k !== void 0 ? _k : false,
                    supportsStructuredJson: (_l = base.supportsStructuredJson) !== null && _l !== void 0 ? _l : false,
                    maxContextTokens: (_m = base.maxContextTokens) !== null && _m !== void 0 ? _m : 4096,
                    recommendedUseCases: ['general'],
                    warningLevel: isExperimental ? 'warning' : 'info',
                    textOnlyMode: (_o = base.textOnlyMode) !== null && _o !== void 0 ? _o : false,
     ...
     */
    static supportsToolCalling(provider, modelName) {
    ...
    static getAllKnownProfiles() {
        return Object.entries(KNOWN_PROFILES).map(([key, partial]) => {
            ...
            return ({
                ...
                status: (_a = partial.status) !== null && _a !== void 0 ? _a : 'custom',
                supportsToolCalling: (_b = partial.supportsToolCalling) !== null && _b !== void 0 ? _b : false,
                supportsStructuredJson: (_c = partial.supportsStructuredJson) !== null && _c !== void 0 ? _c : false,
                maxContextTokens: (_d = partial.maxContextTokens) !== null && _d !== void 0 ? _d : 4096,
                recommendedUseCases: (_e = partial.recommendedUseCases) !== null && _e !== void 0 ? _e : ['general'],
                warningLevel: (_f = partial.warningLevel) !== null && _f !== void 0 ? _f : 'info',
                textOnlyMode: (_g = partial.textOnlyMode) !== null && _g !== void 0 ? _g : true,
...
//# sourceMappingURL=AiModelCapabilityCatalog.js.map