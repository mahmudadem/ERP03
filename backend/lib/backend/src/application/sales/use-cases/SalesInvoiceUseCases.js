    ...
    async execute(input) {
        ...
        for (let i = 0; i < sourceLines.length; i += 1) {
            ...
            lines.push({
                ...
                invoicedQty,
                uomId: sourceLine.uomId || (soLine === null || soLine === void 0 ? void 0 : soLine.uomId) || item.salesUomId || item.baseUomId,
...
class PostSalesInvoiceUseCase {
    ...
    getMatchedDeliveryLines(line, soLine, postedDNs) {
        return postedDNs
            .flatMap((dn) => dn.lines)
            .filter((entry) => (entry.lineId === line.dnLineId
