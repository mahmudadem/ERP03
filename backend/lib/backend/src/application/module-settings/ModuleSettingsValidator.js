...
exports.ModuleSettingsValidator = void 0;
class ModuleSettingsValidator {
    static validate(definition, payload) {
        const errors = [];
        const result = {};
...
exports.ModuleSettingsValidator = ModuleSettingsValidator;
//# sourceMappingURL=ModuleSettingsValidator.js.map