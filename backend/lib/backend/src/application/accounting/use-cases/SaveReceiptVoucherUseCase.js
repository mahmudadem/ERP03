...
class SaveReceiptVoucherUseCase {
    ...
    async execute(input, companyId, userId) {
        ...
        const voucherNo = await this.numberGenerator.generate(companyId, VoucherTypes_1.VoucherType.RECEIPT, input.date);
        ...
        companyId, voucherNo, VoucherTypes_1.VoucherType.RECEIPT, input.date, input.description, currency, baseCurrency, exchangeRate, lines, // Readonly array
...
exports.SaveReceiptVoucherUseCase = SaveReceiptVoucherUseCase;
//# sourceMappingURL=SaveReceiptVoucherUseCase.js.map