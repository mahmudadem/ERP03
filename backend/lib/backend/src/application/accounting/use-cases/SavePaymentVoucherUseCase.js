...
exports.SavePaymentVoucherUseCase = void 0;
...
const PaymentVoucherHandler_1 = require("../../domain/accounting/handlers/PaymentVoucherHandler");
/**
...
class SavePaymentVoucherUseCase {
    constructor(voucherRepository, exchangeRateService, companyService, numberGenerator) {
        ...
        this.handler = new PaymentVoucherHandler_1.PaymentVoucherHandler();
    }
    /**
    ...
    async execute(input, companyId, userId) {
        ...
        const voucherNo = await this.numberGenerator.generate(companyId, VoucherTypes_1.VoucherType.PAYMENT, input.date);
        ...
        companyId, voucherNo, VoucherTypes_1.VoucherType.PAYMENT, input.date, input.description, currency, baseCurrency, exchangeRate, lines, // Readonly array
...
exports.SavePaymentVoucherUseCase = SavePaymentVoucherUseCase;
//# sourceMappingURL=SavePaymentVoucherUseCase.js.map