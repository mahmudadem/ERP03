...
const templates = [
    ...
    },
    {
        ...
        module: "ACCOUNTING",
        headerFields: [
            { id: "customerAccountId", label: "Customer", type: "ACCOUNT_SELECT", required: true, config: { filterType: "ASSET" } },
...
const seedSystemVoucherTypes = async (repo) => {
    ...
    for (const t of templates) {
        if (!existingCodes.has(t.code)) {
            ...
            const def = new VoucherTypeDefinition_1.VoucherTypeDefinition(id, SYSTEM_COMPANY_ID, t.name, t.code, t.module, t.headerFields, t.tableColumns, t.layout, t.workflow);
