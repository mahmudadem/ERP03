# Graph Report - ERP03  (2026-05-16)

## Corpus Check
- 1885 files · ~1,174,615 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14223 nodes · 23345 edges · 809 communities (567 shown, 242 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 407 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fa8cb7e6`
...
1. `Development Journal` - 320 edges
2. `useCompanyAccess()` - 93 edges
3. `ApiError` - 88 edges
4. `PermissionChecker` - 77 edges
5. `Button()` - 75 edges
6. `🎯 Current Focus` - 75 edges
7. `VoucherEntity` - 69 edges
8. `Card()` - 67 edges
9. `InventoryController` - 63 edges
10. `VoucherLineEntity` - 47 edges

## Surprising Connections (you probably didn't know these)
- `withBusyAction()` --calls--> `Action`  [INFERRED]
  frontend/src/modules/purchases/pages/PurchaseOrderDetailPage.tsx → 1-TODO/94-ai-module-finalization.md
- `withBusyAction()` --calls--> `Action`  [INFERRED]
  frontend/src/modules/sales/pages/SalesOrderDetailPage.tsx → 1-TODO/94-ai-module-finalization.md
- `cn()` --calls--> `clsx()`  [INFERRED]
  auth-wizard/utils.ts → frontend/src/modules/accounting/components/VoucherTable.tsx
...
- `Button()` --calls--> `clsx()`  [INFERRED]
  Voucher-Wizard/components/ui/Button.tsx → frontend/src/modules/accounting/components/VoucherTable.tsx

## Communities (809 total, 242 thin omitted)
...
Cohesion: 0.02
Nodes (47): FirestoreUserAccessScopeProvider, compareAccountStatementRows(), compareVoucherNo(), dateToIso(), FirestoreLedgerRepository, serverTimestamp(), toTimestamp(), toTimestampBoundary() (+39 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (58): Item, toDate(), Party, toDate(), PurchaseSettings, roundMoney(), SalesOrder, toDate() (+50 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (58): setAuthTokenGetter(), setCompanyIdGetter(), FirebaseAuthProvider, getFirebaseAuthProvider(), mapFirebaseUser(), RequireAuth(), RequireModule(), RequireOnboarding() (+50 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (43): WizardNavigation(), formatCompanyDate(), loadHistory(), handleSubmit(), handleSubmit(), formatCompanyDate(), useCompanySettings(), handleSaveWeb() (+35 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (53): setupErrorInterceptor(), SuperAdminHeader(), SuperAdminPage(), SuperAdminPanel(), SuperAdminStatCard(), SuperAdminTable(), useSuperAdminTable(), handleDisable() (+45 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (68): handleAction(), handleSave(), load(), unwrap(), createEmptyForm(), createEmptyLine(), todayIso(), load() (+60 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (41): InventoryPeriodSnapshot, toDate(), ItemCategory, StockAdjustment, toDate(), StockTransfer, toDate(), toDate() (+33 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (68): handleClose(), handleRunDiagnostics(), useAccounts(), useCompanyModules(), load(), load(), load(), load() (+60 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (39): InventorySettings, FirestoreInventorySettingsRepository, getInventorySettingsRef(), ManageCategoriesUseCase, ConfigureInventoryFinancialIntegrationUseCase, GetCurrentCostUseCase, GetInventoryDashboardUseCase, GetLowStockAlertsUseCase (+31 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (15): TrialBalanceTool, MockSuccessTool, AiChatMessage, AiProviderConfig, AiUsageLog, ProviderFactory, ProviderProviderError, AiAuditService (+7 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (34): GetAccountBalanceTool, round2(), GetAccountStatementSummaryTool, round2(), GetAgingPayablesTool, round2(), GetAgingReceivablesTool, round2() (+26 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (24): BankReconciliationController, ConsolidationController, ReportingController, SettingsController, formatUserDisplayName(), getUserAuditSnapshot(), VoucherSequenceController, PostingError (+16 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (35): createAggregatedPolicyError(), createPostingError(), VoucherValidationService, CreateGoodsReceiptUseCase, findPOLine(), GetGoodsReceiptUseCase, ListGoodsReceiptsUseCase, PostGoodsReceiptUseCase (+27 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (42): GoodsReceipt, roundMoney(), toDate(), normalizeDocumentSource(), PurchaseInvoice, roundMoney(), toDate(), PurchaseOrder (+34 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (20): PrismaAiChatRepository, FirebaseTokenVerifier, PrismaChartOfAccountsTemplateRepository, PrismaCurrencyRepository, PrismaInventoryTemplateRepository, AesEncryptionService, PrismaInventorySettingsRepository, getPrismaClient() (+12 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (45): ModuleStatusBanner(), useVoucherTypeDefinition(), canonicalToUi(), transformCanonicalLayout(), documentUiToCanonical(), transformLayout(), transformLayout(), uiToCanonical() (+37 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (40): DeliveryNote, roundMoney(), toDate(), normalizeDocumentSource(), roundMoney(), SalesInvoice, toDate(), toDisplayText() (+32 more)

### Community 18 - "Community 18"
Cohesion: 0.04
Nodes (27): AccountingDTOMapper, buildDraftVoucher(), buildLines(), roundMoney(), VoucherLineEntity, VoucherPostingStrategyFactory, JournalEntryHandler, OpeningBalanceHandler (+19 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (33): InventoryController, ensureAccountingMode(), ensureBoolean(), ensureInventoryAccountingMethod(), ensureIsoDate(), ensureOptionalString(), ensurePositiveNumber(), ensureRequiredString() (+25 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (15): AccountingDesignerController, ApiError, DeleteCompanyUserUseCase, DisableCapabilityForCompanyUseCase, DisableCompanyUserUseCase, DisableModuleForCompanyUseCase, EnableCapabilityForCompanyUseCase, EnableCompanyUserUseCase (+7 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (35): ItemCardWindow(), PartyCardWindow(), handleNew(), handleRateDeviationConfirm(), handleRateDeviationSync(), handleSaveVoucher(), normalizeSemanticPayload(), performSave() (+27 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (21): StockLevel, toDate(), StockMovement, toDate(), addDefaultContext(), createCompany(), createItem(), createWarehouse() (+13 more)
...
Cohesion: 0.05
Nodes (13): PermissionCatalogSyncService, deriveModuleBundlesFromPermissions(), FirestorePermissionRegistryRepository, PermissionRegistryController, CreateCompanyRoleUseCase, CreatePermissionUseCase, DeleteCompanyRoleUseCase, DeletePermissionUseCase (+5 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (40): addRow(), applyAIData(), copyToClipboard(), handleAIAutoFill(), handleImageImport(), handleInputChange(), addRow(), applyAIData() (+32 more)
...
Cohesion: 0.05
Nodes (13): FirestoreFiscalYearRepository, toDomain(), toPersistence(), FiscalYear, FiscalPeriodGenerator, ClosePeriodUseCase, CloseYearUseCase, CommitYearCloseUseCase (+5 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (10): AccountingModule, AiAssistantModule, InventoryModule, registerAllModules(), runCapabilityStartupValidation(), runModuleStartupValidation(), runPermissionStartupValidation(), PurchaseModule (+2 more)

### Community 29 - "Community 29"
Cohesion: 0.07
Nodes (11): isAiCertificationCategory(), AiModelCertificationResult, AiModelProfile, AiCertificationEngine, evaluateResponse(), evaluateShouldAnswerFromData(), evaluateShouldRefuse(), evaluateShouldRefuseOrProposeDraft() (+3 more)
...
Cohesion: 0.06
Nodes (10): useCompanyBundles(), useCompanyFeatures(), useCompanyModules(), useCompanyProfile(), useCompanyRoles(), useCompanyUsers(), CompanyAdminLayout(), clearEditQueryParam() (+2 more)

### Community 32 - "Community 32"
Cohesion: 0.08
Nodes (11): AiCreditController, AiMaintenanceController, ownerOrPermissionGuard(), assertSuperAdmin(), authMiddleware(), companyContextMiddleware(), permissionsMiddleware(), PlanRegistryController (+3 more)

### Community 33 - "Community 33"
Cohesion: 0.05
Nodes (38): Action, code:bash (git add -A), cancelOrder(), closeOrder(), confirmOrder(), createEmptyForm(), createEmptyLine(), deleteDraft() (+30 more)

### Community 34 - "Community 34"
Cohesion: 0.05
Nodes (16): RequirePermission(), DocumentDesigner(), handleDelete(), handleEdit(), isProtected(), handleClickOutside(), handleDelete(), handleEdit() (+8 more)
...
Cohesion: 0.06
Nodes (16): useActiveBreakpoint(), useBreakpoint(), useDocumentActions(), useUiMode(), useUserPreferences(), Sidebar(), TopBar(), handleMouseEnter() (+8 more)
...
Cohesion: 0.06
Nodes (10): Company, CompanyPgMapper, EnableModuleForCompanyUseCase, GetCompanyDetailsUseCase, UpdateCompanySettingsUseCase, CreateCompanyUseCase, UpdateCompanyProfileUseCase, AssignRoleToCompanyUserUseCase (+2 more)

### Community 39 - "Community 39"
Cohesion: 0.05
Nodes (21): ProtectedRoute(), FeedbackButtons(), handleNewConversation(), startNewChat(), ItemMasterCard(), handleAutoGenerateCode(), handleSave(), loadParty() (+13 more)
...
Cohesion: 0.05
Nodes (19): CurrencyDropdown(), cleanFieldLabel(), closeLineContextMenu(), evaluateMathExpression(), getAliasedFieldLabel(), getCellKey(), getFieldDisplayLabel(), handleAccountBalance() (+11 more)

### Community 43 - "Community 43"
Cohesion: 0.07
Nodes (24): clamp(), clampSpan(), findFirstAvailableSpace(), getBorderClassForWidget(), getWidgetEnd(), handleDragEnd(), hasCollision(), moveWidget() (+16 more)
...
Cohesion: 0.08
Nodes (21): AuthError, BusinessError, InfrastructureError, ValidationError, buildUseCase(), makeExistingSettings(), cloneTemplateValue(), cloneVoucherFormForCompany() (+13 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (8): User, SuperAdminController, DemoteSuperAdminUseCase, GetSystemOverviewUseCase, ListAllCompaniesUseCase, ListAllUsersUseCase, PromoteUserToSuperAdminUseCase, SignupUseCase

### Community 52 - "Community 52"
Cohesion: 0.08
Nodes (7): CompanyWizardController, GetAvailableCompanyModelsUseCase, GetNextWizardStepUseCase, GetOptionsForFieldUseCase, GetWizardStepsForModelUseCase, StartCompanyCreationWizardUseCase, SubmitWizardStepUseCase
...
Cohesion: 0.08
Nodes (8): FirestoreBudgetRepository, toTimestamp(), PrismaBudgetRepository, Budget, ApproveBudgetUseCase, CreateBudgetUseCase, GetBudgetVsActualUseCase, UpdateBudgetUseCase
...
Cohesion: 0.07
Nodes (7): FirestoreChartOfAccountsTemplateRepository, FirestoreInventoryTemplateRepository, CompanyUser, InfrastructureError, CompanyMapper, CompanyUserMapper, UserMapper
...
Cohesion: 0.08
Nodes (13): PaymentHistory, roundMoney(), toDate(), toStr(), getSharedCollection(), getSharedDataRef(), getSharedModuleRef(), PostPurchaseInvoiceWithSettlementUseCase (+5 more)
...
Cohesion: 0.07
Nodes (8): PrismaCostCenterRepository, CostCenter, ActivateCostCenterUseCase, CreateCostCenterUseCase, DeactivateCostCenterUseCase, DeleteCostCenterUseCase, ListCostCentersUseCase, UpdateCostCenterUseCase
...
Cohesion: 0.06
Nodes (5): RolePermissionResolver, ModulePermissionsController, PermissionSyncService, PrismaModulePermissionsDefinitionRepository, SystemRoleController
...
Cohesion: 0.08
Nodes (7): FirestoreImpersonationRepository, ImpersonationController, ImpersonationSession, PrismaImpersonationRepository, ImpersonationMapper, StartImpersonationUseCase, StopImpersonationUseCase
...
Cohesion: 0.07
Nodes (7): CompanyFeaturesController, CompanyProfileController, CompanyRolesController, CompanyUsersController, ListActiveCompanyFeaturesUseCase, ListCompanyFeaturesUseCase, ToggleFeatureFlagUseCase
...
Cohesion: 0.1
Nodes (22): ActionMenu(), handleExpireCertification(), handleRecordManualCert(), handleRunShellCert(), loadCertifications(), applyProviderToForm(), closeModal(), handleDelete() (+14 more)
...
Cohesion: 0.06
Nodes (35): 2026-05-08 Settings Diagnostics Update, 2026-05-08 Update, 2026-05-09 Context Budget and Cost Controls, 2026-05-09 Conversation Context Update, 2026-05-09 Editable Model Profile Catalog, AI Assistant Runtime v2 Architecture, Backend Trust Foundation: Provider -> Profile -> Certification -> Routing, Certification Engine Shell (+27 more)
...
Cohesion: 0.11
Nodes (8): AiAssistantDTOMapper, handleStream(), certificationCategoryForModule(), CheckProviderHealthUseCase, ExecuteAiToolUseCase, GetUsageAnalyticsUseCase, validateSendChatMessageInput(), validateUpdateAiSettingsInput()

### Community 87 - "Community 87"
Cohesion: 0.08
Nodes (7): PrismaRecurringVoucherTemplateRepository, RecurringVoucherTemplate, CreateRecurringTemplateUseCase, GenerateRecurringVouchersUseCase, PauseRecurringTemplateUseCase, ResumeRecurringTemplateUseCase, UpdateRecurringTemplateUseCase

### Community 88 - "Community 88"
Cohesion: 0.1
Nodes (7): CreateBundleUseCase, DeleteBundleUseCase, GetCompanyBundleUseCase, ListAvailableBundlesUseCase, ListBundlesUseCase, UpdateBundleUseCase, UpgradeCompanyBundleUseCase
...
Cohesion: 0.1
Nodes (3): ModuleRegistry, ModuleAvailabilityController, CheckModuleImplementationUseCase
...
Cohesion: 0.09
Nodes (12): assertValidPurchaseTaxCode(), CreatePurchaseInvoiceUseCase, findPOLine(), hasGRNForThisLine(), hasNativeLinkedPurchaseSource(), normalizePurchaseInvoiceToken(), PostPurchaseInvoiceUseCase, resolveDocumentSource() (+4 more)
...
Cohesion: 0.21
Nodes (29): ensureBoolean(), ensureIsoDate(), ensureNonNegativeNumber(), ensureNumber(), ensureOptionalNumber(), ensureOptionalString(), ensureOptionalUuid(), ensurePositiveNumber() (+21 more)

### Community 104 - "Community 104"
Cohesion: 0.11
Nodes (5): FirestoreCompanyGroupRepository, toTimestamp(), PrismaCompanyGroupRepository, CompanyGroup, GetConsolidatedTrialBalanceUseCase

### Community 105 - "Community 105"
Cohesion: 0.11
Nodes (3): CostCenterMapper, FirestoreCurrencyRepository, SettingsResolver

### Community 107 - "Community 107"
Cohesion: 0.12
Nodes (6): ProviderAuthError, ProviderError, ProviderRateLimitError, ProviderUnavailableError, AxiosHttpClient, OpenAICompatibleProvider

### Community 108 - "Community 108"
Cohesion: 0.11
Nodes (3): EntitlementService, CompanyRolePermissionResolver, CreateCompanyUseCase
...
Cohesion: 0.11
Nodes (14): handleEnter(), load(), savePreferences(), setAppearanceSettings(), setUiMode(), applyDraft(), reset(), save() (+6 more)
...
Cohesion: 0.1
Nodes (8): Permission, AuditLogMapper, ModuleMapper, NotificationMapper, PermissionMapper, RoleMapper, FirestoreAuditLogRepository, FirestorePermissionRepository
...
Cohesion: 0.11
Nodes (5): FirestoreAiCreditLedgerRepository, stripUndefinedDeep(), AiCreditLedger, GetAiCreditBalanceUseCase, GrantAiCreditsUseCase

### Community 129 - "Community 129"
Cohesion: 0.11
Nodes (5): CompanySettingsController, FirestoreCompanySettingsRepository, PrismaCompanySettingsRepository, CompanySettingsDTOMapper, CompanySettings
...
Cohesion: 0.16
Nodes (5): createReportToolClass(), currentMonthStart(), ReportRunner, round2(), today()

### Community 149 - "Community 149"
Cohesion: 0.09
Nodes (3): AccountingBootstrapService, FirestoreModuleSettingsDefinitionRepository, PrismaModuleSettingsDefinitionRepository
...
Cohesion: 0.18
Nodes (12): cloneValue(), cloneVoucherFormForCompany(), cloneVoucherTypeForCompany(), normalizeCode(), normalizeModule(), syncCompanyVoucherTemplatesFromSystem(), canonicalizeVoucherCode(), getVoucherFormLogicalKey() (+4 more)
...
Cohesion: 0.16
Nodes (11): handleEnable(), loadMatrix(), fetchInverseRateSuggestion(), getDeviationColor(), handleCancelSave(), handleConfirmSave(), handleSubmit(), performSave() (+3 more)
...
Cohesion: 0.11
Nodes (3): MockHttpClient, SequenceHttpClient, AiRateLimiterService
...
Cohesion: 0.12
Nodes (16): Account Balance Tool Results, AI Assistant Runtime v2 — User Guide, AI Proposals, Certification Workflows, Certified Model Safety, code:text (Show me the balance for account 1010101), Controlling Context Cost, Follow-Up Questions (+8 more)
...
Cohesion: 0.16
Nodes (8): CustomerAccountSelector(), VendorAccountSelector(), buildCreateSeed(), handleCreateParty(), handleInputBlur(), handleInputKeyDown(), handleOpenCreateModal(), handleSelect()
...
Cohesion: 0.18
Nodes (7): AppError, errorHandler(), getProviderErrorStatus(), getStatusCode(), isFirestoreTransactionError(), impersonationMiddleware(), ValidateImpersonationSessionUseCase
...
Cohesion: 0.15
Nodes (3): useCostCenters(), closeModal(), handleSave()
...
Cohesion: 0.17
Nodes (4): makeSystemVoucherForm(), nowDate(), GetSalesSettingsUseCase, InitializeSalesUseCase
...
Cohesion: 0.17
Nodes (13): formatSummaryFieldValue(), getDerivedLineGrossTotal(), getDerivedLineTaxTotal(), getDerivedLineTotal(), getLineQuantity(), getLineTaxRate(), getLineUnitPrice(), getRowValue() (+5 more)
...
Cohesion: 0.18
Nodes (3): SuperAdminEntitlementsController, GrantModuleToCompanyUseCase, RevokeModuleFromCompanyUseCase
...
Cohesion: 0.29
Nodes (8): findExactMatch(), getCCByCode(), getCCById(), getFilteredCenters(), handleInputBlur(), handleInputKeyDown(), handleModalKeyDown(), handleSelectCC()
...
Cohesion: 0.28
Nodes (3): CompanyController, CoreDTOMapper, validateCreateCompanyInput()
...
Cohesion: 0.25
Nodes (7): Files, Layout Model, Migration Notes, Purpose, Styling Model, Topbar Precision Widget Layout, Verification
...
Cohesion: 0.29
Nodes (6): Adding Widgets, How To Edit The Top Bar, Tips, Topbar Widget Layout, What It Does, Who Can Use It

### Community 609 - "Community 609"
Cohesion: 0.4
Nodes (3): buildToolCallSignature(), stableStringify(), StreamChatMessageUseCase
...
Cohesion: 0.33
Nodes (5): AI Assistant Credits Runtime Architecture, APIs, Chat Flow, Credit Ledger, Runtime Modes
...
Cohesion: 0.4
Nodes (4): AI Assistant Credits, If Credits Run Out, Runtime Options, What AI Credits Mean
...
## Knowledge Gaps
- **3764 isolated node(s):** `MockHttpClient`, `What Was Built (Task 93 — Phase 1)`, `🛠️ Recent Fixes (AI Assistant Tooling & Stabilization)`, `Phase 1A Progress`, `Subtasks Completed` (+3759 more)
...
- **Why does `Account` connect `Community 239` to `Community 3`, `Community 263`, `Community 11`, `Community 461`, `Community 18`, `Community 56`, `Community 281`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `NewVoucherFormsDemo()` connect `Community 3` to `Community 239`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `useCompanyAccess()` connect `Community 3` to `Community 33`, `Community 34`, `Community 35`, `Community 4`, `Community 36`, `Community 6`, `Community 39`, `Community 8`, `Community 42`, `Community 172`, `Community 16`, `Community 21`, `Community 151`, `Community 152`, `Community 25`, `Community 26`, `Community 31`?**
...
- **What connects `MockHttpClient`, `What Was Built (Task 93 — Phase 1)`, `🛠️ Recent Fixes (AI Assistant Tooling & Stabilization)` to the rest of the system?**
