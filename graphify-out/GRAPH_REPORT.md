...
## Corpus Check
- 1859 files · ~1,144,850 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 13694 nodes · 22589 edges · 845 communities (575 shown, 270 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 390 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d15ad7df`
...
1. `Development Journal` - 262 edges
...
## Communities (845 total, 270 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (258): 2026-04-26 (Sat) — 2h, 2026-04-26 (Sat) — Session 0: Process Setup, 2026-04-27 (Mon) — 0.1h, 2026-04-27 (Mon) — 0.2h, 2026-04-27 (Mon) — 0.2h, 2026-04-27 (Mon) — 0.2h, 2026-04-27 (Mon) — 0.2h, 2026-04-27 (Mon) — 0.2h (+250 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (45): ConsolidationController, formatUserDisplayName(), getUserAuditSnapshot(), VoucherSequenceController, PermissionChecker, GetAccountBalanceTool, round2(), GetAccountStatementSummaryTool (+37 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (52): loadOptions(), WizardNavigation(), useWizardSession(), useCompanyBundles(), useCompanyFeatures(), useCompanyModules(), useCompanyProfile(), useCompanyRoles() (+44 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (58): handleEnable(), formatCompanyDate(), loadHistory(), loadMatrix(), handleSubmit(), handleSubmit(), formatCompanyDate(), useCompanySettings() (+50 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (59): handleClose(), handleRunDiagnostics(), useAccounts(), useCompanyModules(), useDocumentActions(), handleSubmit(), load(), unwrap() (+51 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (35): ProtectedRoute(), RequireModule(), RequirePermission(), SuperAdminRedirect(), DocumentDesigner(), handleDelete(), handleEdit(), isProtected() (+27 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (40): DeliveryNote, roundMoney(), toDate(), Item, toDate(), Party, toDate(), roundMoney() (+32 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (61): createEmptyForm(), createEmptyLine(), todayIso(), createEmptyForm(), createEmptyLine(), todayIso(), createEmptyForm(), createEmptyLine() (+53 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (30): InventoryPeriodSnapshot, toDate(), ItemCategory, StockAdjustment, toDate(), StockTransfer, toDate(), UomConversion (+22 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (18): FirebaseTokenVerifier, PrismaChartOfAccountsTemplateRepository, PrismaCurrencyRepository, PrismaInventoryTemplateRepository, AesEncryptionService, PrismaInventorySettingsRepository, getPrismaClient(), PrismaTransactionManager (+10 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (32): setAuthTokenGetter(), setCompanyIdGetter(), FirebaseAuthProvider, getFirebaseAuthProvider(), mapFirebaseUser(), RequireAuth(), RequireOnboarding(), PageTitleManager() (+24 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (48): useAccountingSettings(), useCompanyCurrencies(), load(), buildCreateSeed(), handleCreateParty(), handleInputBlur(), handleInputKeyDown(), handleOpenCreateModal() (+40 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (13): buildDraftVoucher(), buildLines(), VoucherEntity, moneyEquals(), ApprovalPolicyService, ConfirmCustodyUseCase, PostPurchaseInvoiceWithSettlementUseCase, recalcPaymentStatus() (+5 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (37): ItemCardWindow(), PartyCardWindow(), handleNew(), handleRateDeviationConfirm(), handleRateDeviationSync(), handleSaveVoucher(), normalizeSemanticPayload(), performSave() (+29 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (32): GoodsReceipt, roundMoney(), toDate(), normalizeDocumentSource(), PurchaseInvoice, roundMoney(), toDate(), PurchaseReturn (+24 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (12): TrialBalanceTool, MockSuccessTool, getCatalogDefinition(), getExecutableDefinitions(), AiToolDefinition, modeToOperationType(), ProviderProviderError, AiAuditService (+4 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (15): AccountingDesignerController, ApiError, deriveModuleBundlesFromPermissions(), CreateCompanyRoleUseCase, DeleteCompanyRoleUseCase, GetCompanyRoleUseCase, GetOnboardingStatusUseCase, GrantModuleToCompanyUseCase (+7 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (32): PurchaseOrder, roundMoney(), toDate(), PurchaseSettings, makeGRN(), makeItem(), makePI(), makePO() (+24 more)
...
Cohesion: 0.04
Nodes (8): MockTool, PrismaAiSettingsRepository, MockHttpClient, SequenceHttpClient, AiProviderConfig, MockProvider, ProviderFactory, AiRateLimiterService

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (19): roundMoney(), VoucherLineEntity, OpeningBalanceHandler, PaymentVoucherHandler, ReceiptVoucherHandler, FXRevaluationStrategy, JournalEntryStrategy, OpeningBalanceStrategy (+11 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (19): StockLevel, toDate(), StockMovement, toDate(), addDefaultContext(), createCompany(), createItem(), createWarehouse() (+11 more)

### Community 22 - "Community 22"
Cohesion: 0.05
Nodes (9): SettingsController, FirestoreChartOfAccountsTemplateRepository, FirestoreCurrencyRepository, FirestoreInventoryTemplateRepository, PrismaCompanySettingsRepository, CompanySettings, InfrastructureError, ModuleActivationService (+1 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (28): TaxCode, toDate(), PartyMapper, stripUndefinedDeep(), TaxCodeMapper, toDate(), toTimestamp(), makeAfterInvoiceReturn() (+20 more)
...
Cohesion: 0.05
Nodes (10): PrismaCompanyCreationSessionRepository, PrismaCompanyWizardTemplateRepository, CompanyWizardController, CompleteCompanyCreationUseCase, GetAvailableCompanyModelsUseCase, GetNextWizardStepUseCase, GetOptionsForFieldUseCase, GetWizardStepsForModelUseCase (+2 more)
...
Cohesion: 0.05
Nodes (29): confirmAddSpecialPeriod(), confirmClosePeriod(), confirmCloseYear(), confirmDeleteYear(), confirmReopenPeriod(), confirmReopenYear(), handleAutoCreateRetainedEarnings(), handleClosePeriod() (+21 more)

### Community 29 - "Community 29"
Cohesion: 0.07
Nodes (7): isAiCertificationCategory(), AiModelCertificationResult, AiModelProfile, AiAutoSeedCertification, AiCertificationEngine, AiModelRoutingGuard, AiModelCertificationUseCase

### Community 30 - "Community 30"
Cohesion: 0.06
Nodes (34): handleClose(), handleSubmit(), clsx(), deepMergeObjects(), dispatchUpdate(), firstDisplayText(), firstEntityRef(), isPlainObject() (+26 more)

### Community 31 - "Community 31"
Cohesion: 0.08
Nodes (19): AuthPermissionsController, CompanyCapabilityEntity, tenantContextMiddleware(), buildRegistryIndexes(), getCapabilityBlockedReason(), isCapabilityEntitled(), normalize(), normalizeList() (+11 more)

### Community 32 - "Community 32"
Cohesion: 0.09
Nodes (8): VoucherTypeController, moduleInitializedGuard(), assertSuperAdmin(), authMiddleware(), permissionsMiddleware(), TemplatesController, SystemController, UserCompaniesController
...
Cohesion: 0.06
Nodes (9): FirestoreBankStatementRepository, toTimestamp(), FirestoreReconciliationRepository, toTimestamp(), PrismaReconciliationRepository, BankStatement, Reconciliation, MemoryBankRepo (+1 more)
...
Cohesion: 0.06
Nodes (14): useActiveBreakpoint(), useBreakpoint(), useUiMode(), useUserPreferences(), Sidebar(), handleMouseEnter(), updateCoords(), handleCreate() (+6 more)
...
Cohesion: 0.05
Nodes (6): AccountingBootstrapService, RolePermissionResolver, FirestoreModuleSettingsDefinitionRepository, PermissionSyncService, PrismaModulePermissionsDefinitionRepository, PrismaModuleSettingsDefinitionRepository

### Community 39 - "Community 39"
Cohesion: 0.1
Nodes (19): SuperAdminHeader(), SuperAdminPage(), SuperAdminPanel(), SuperAdminStatCard(), SuperAdminTable(), useSuperAdminTable(), handleDelete(), handleSubmit() (+11 more)
...
Cohesion: 0.05
Nodes (20): toOptionalGRNStatus(), toOptionalNumber(), toOptionalPaymentStatus(), toOptionalPIStatus(), toOptionalPRStatus(), toOptionalStatus(), GetGoodsReceiptUseCase, ListGoodsReceiptsUseCase (+12 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (12): VoucherFormController, AppError, AuthError, BusinessError, InfrastructureError, ValidationError, makePostedVoucher(), makeVoucher() (+4 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (9): registerAllModules(), runCapabilityStartupValidation(), runModuleStartupValidation(), runPermissionStartupValidation(), EntitlementServiceAdapter, ModuleRegistry, initServer(), ModuleAvailabilityController (+1 more)
...
Cohesion: 0.09
Nodes (14): PaymentHistory, roundMoney(), toDate(), toStr(), normalizeDocumentSource(), roundMoney(), SalesInvoice, toDate() (+6 more)

### Community 51 - "Community 51"
Cohesion: 0.07
Nodes (9): FirestoreImpersonationRepository, ImpersonationController, ImpersonationSession, PrismaImpersonationRepository, ImpersonationMapper, impersonationMiddleware(), StartImpersonationUseCase, StopImpersonationUseCase (+1 more)
...
Cohesion: 0.08
Nodes (11): MockHttpClient, errorHandler(), getProviderErrorStatus(), getStatusCode(), isFirestoreTransactionError(), ProviderAuthError, ProviderError, ProviderRateLimitError (+3 more)

### Community 55 - "Community 55"
Cohesion: 0.09
Nodes (16): roundMoney(), SalesReturn, toDate(), DeliveryNoteMapper, SalesInvoiceMapper, SalesOrderMapper, SalesReturnMapper, SalesSettingsMapper (+8 more)

### Community 56 - "Community 56"
Cohesion: 0.06
Nodes (9): CostCenterController, CostCenterMapper, CostCenter, ActivateCostCenterUseCase, CreateCostCenterUseCase, DeactivateCostCenterUseCase, DeleteCostCenterUseCase, ListCostCentersUseCase (+1 more)
...
Cohesion: 0.08
Nodes (4): EntitlementService, CompanyRolePermissionResolver, PrismaCompanyRoleRepository, CreateCompanyUseCase
...
Cohesion: 0.08
Nodes (16): toOptionalDNStatus(), toOptionalNumber(), toOptionalPaymentStatus(), toOptionalSIStatus(), toOptionalSRStatus(), toOptionalStatus(), GetSalesInvoiceUseCase, ConfirmSalesOrderUseCase (+8 more)
...
Cohesion: 0.09
Nodes (14): buildUseCase(), makeExistingSettings(), makeSystemVoucherForm(), nowDate(), cloneTemplateValue(), cloneVoucherFormForCompany(), cloneVoucherTypeForCompany(), ensurePurchaseVoucherDefinitions() (+6 more)

### Community 93 - "Community 93"
Cohesion: 0.09
Nodes (4): ModuleAvailabilityService, DisableModuleForCompanyUseCase, EnableModuleForCompanyUseCase, ListCompanyModulesUseCase
...
Cohesion: 0.13
Nodes (6): DesignerDTOMapper, FieldDefinition, FormDefinition, VoucherTypeDefinition, FormDefinitionMapper, VoucherTypeDefinitionMapper
...
Cohesion: 0.09
Nodes (6): PrismaRecurringVoucherTemplateRepository, RecurringVoucherTemplate, CreateRecurringTemplateUseCase, GenerateRecurringVouchersUseCase, ResumeRecurringTemplateUseCase, UpdateRecurringTemplateUseCase

### Community 105 - "Community 105"
Cohesion: 0.07
Nodes (6): CompanyBundleController, CompanyFeaturesController, CompanyProfileController, CompanyRolesController, CompanyUsersController, UpdateCompanyProfileUseCase

### Community 106 - "Community 106"
Cohesion: 0.11
Nodes (11): handleBack(), handleCreateNew(), handleDelete(), handleEdit(), handleSave(), handleMouseDown(), handleMouseMove(), handleMouseUp() (+3 more)
...
Cohesion: 0.1
Nodes (5): ModuleRegistryController, CreateModuleUseCase, DeleteModuleUseCase, ListModulesUseCase, UpdateModuleUseCase
...
Cohesion: 0.11
Nodes (5): InventorySettings, FirestoreInventorySettingsRepository, getInventorySettingsRef(), InventorySettingsMapper, ConfigureInventoryFinancialIntegrationUseCase
...
Cohesion: 0.11
Nodes (5): DeleteCompanyUserUseCase, DisableCompanyUserUseCase, EnableCompanyUserUseCase, InviteCompanyUserUseCase, UpdateCompanyUserRoleUseCase

### Community 126 - "Community 126"
Cohesion: 0.09
Nodes (4): FirestoreCompanyUserRepository, PrismaCompanyUserRepository, CompanyUser, CompanyUserMapper
...
Cohesion: 0.12
Nodes (7): AuditLog, AuditLogMapper, ModuleMapper, NotificationMapper, PermissionMapper, RoleMapper, FirestorePermissionRepository

### Community 135 - "Community 135"
Cohesion: 0.14
Nodes (7): cn(), handleNext(), handleSelect(), handleSubmit(), validate(), handleCreate(), StepSuccess()

### Community 136 - "Community 136"
Cohesion: 0.12
Nodes (7): setupErrorInterceptor(), fetchInverseRateSuggestion(), getDeviationColor(), handleCancelSave(), handleConfirmSave(), handleSubmit(), performSave()
...
Cohesion: 0.13
Nodes (6): AiCreditController, companyModuleGuard(), ownerOrPermissionGuard(), permissionGuard(), companyContextMiddleware(), NotificationController
...
Cohesion: 0.13
Nodes (4): Notification, LogAuditActionUseCase, MarkNotificationAsReadUseCase, SendNotificationUseCase

### Community 162 - "Community 162"
Cohesion: 0.13
Nodes (11): useCostCenters(), handleSaveWeb(), fetchReport(), findExactMatch(), getCCByCode(), getCCById(), getFilteredCenters(), handleInputBlur() (+3 more)
...
Cohesion: 0.14
Nodes (6): AiAssistantDTOMapper, handleStream(), AiSettingsUseCase, ExecuteAiToolUseCase, validateSendChatMessageInput(), validateUpdateAiSettingsInput()
...
Cohesion: 0.13
Nodes (3): PrismaAiUsageLogRepository, AiUsageLog, GetUsageAnalyticsUseCase
...
Cohesion: 0.1
Nodes (20): Changes — Subtask A: Backend Model Profile Runtime Config (3 files), Changes — Subtask B: Provider Default API Key (4 files), Changes — Subtask C: Chat Runtime API Key Fallback (1 file), Changes — Subtask D: Frontend Updates (5+ files), How to test:, Previous Focus — Fix Certification Failures + Add Provider API Key Management, Problem, Problem (+12 more)
...
Cohesion: 0.17
Nodes (3): FirestoreBudgetRepository, toTimestamp(), PrismaBudgetRepository
...
Cohesion: 0.18
Nodes (5): mapDto(), UserPreferencesController, UserPreferences, GetUserPreferencesUseCase, UpsertUserPreferencesUseCase
...
Cohesion: 0.11
Nodes (18): ✅ 2026-05-08 Result, Detour: AI Chat 30s Timeout, Detour: Frontend Ngrok Host Allowlist, Files Changed By This Task, Follow-up: AI Settings Model Diagnostics, Follow-up: Conversation Context Cost Settings, Follow-up: Conversation Context First Rules, Follow-up: Editable AI Model Profiles (+10 more)
...
Cohesion: 0.19
Nodes (3): CreateBundleUseCase, ListAvailableBundlesUseCase, UpdateBundleUseCase
...
Cohesion: 0.12
Nodes (17): 2026-05-12 Result — AI Assistant Fixing Plan Phase 1 Business Model Fix, 2026-05-12 Result — AI Assistant Fixing Plan Phase 2 Security Hardening, 2026-05-13 Result — AI Assistant Fixing Plan Phase 3B/3C Tool Truncation Signals, Changes, Completed Subtasks, Completed Subtasks, Completed Subtasks, Detours (+9 more)
...
Cohesion: 0.12
Nodes (16): Changes:, Changes:, Changes:, Changes:, Changes:, Changes:, Changes:, Previous Focus — Modal-based UX Rewrite for AiModelProfilesPage (+8 more)
...
Cohesion: 0.23
Nodes (3): AttendanceRecord, AttendanceMapper, EmployeeMapper
...
Cohesion: 0.14
Nodes (14): 2026-05-12 Progress — AI Assistant Fixing Plan Phase 1D, 2026-05-12 Progress — AI Assistant Fixing Plan Phase 2A, 2026-05-13 Progress — AI Assistant Fixing Plan Phase 3A, Changes, Changes, Changes, Changes, Follow-Up Notes (+6 more)

### Community 300 - "Community 300"
Cohesion: 0.15
Nodes (14): 2026-05-13 Result — Phase 6.6 Simplified Tenant AI Setup Wizard, Changes, Changes, Changes, Changes, code:typescript (interface AiSetupWizardProps {), Current Focus — Correct Credential/Provider Design (runtimeMode + platformRuntimeCredential), Design Rules Enforced: (+6 more)
...
Cohesion: 0.17
Nodes (3): BundleRegistryController, DeleteBundleUseCase, ListBundlesUseCase
...
Cohesion: 0.2
Nodes (4): CompanyController, CoreDTOMapper, CreateCompanyUseCase, validateCreateCompanyInput()
...
Cohesion: 0.17
Nodes (11): Acceptance Criteria, code:text (backend implementation exists), code:text (Entitled = company is allowed to use something.), code:text (Is company entitled to crm.ai-scoring?), code:text (Company Admin module list does not read raw code registry.), code:text (You are executing the final module architecture refactor for), Copy-Ready Handoff Prompt For Executing Agent, Core Decision (+3 more)
...
Cohesion: 0.25
Nodes (6): buildLevelKey(), CreatePeriodSnapshotUseCase, GetAsOfValuationUseCase, getPeriodEndDate(), isValidIsoDate(), isValidPeriodKey()
...
Cohesion: 0.22
Nodes (3): HrDTOMapper, HrController, RegisterEmployeeUseCase
...
Cohesion: 0.2
Nodes (10): 2026-05-12 Progress — AI Assistant Fixing Plan Phase 1A, Changes, Changes, Changes, Rabbit Holes Logged, Rabbit Holes Logged, Rabbit Holes Logged, Review / Verification (+2 more)
...
Cohesion: 0.22
Nodes (9): 2026-05-12 Progress — Super Admin Diagnostics Modal + UX Refactor, Changes, Changes, Changes, Detour Fix — Silent Mock Fallback in Diagnostics, Files Changed, Verification, Verification (+1 more)
...
Cohesion: 0.43
Nodes (6): evaluateResponse(), evaluateShouldAnswerFromData(), evaluateShouldRefuse(), evaluateShouldRefuseOrProposeDraft(), evaluateShouldRequestTool(), runAllTests()
...
Cohesion: 0.25
Nodes (8): 2026-05-12 Progress — AI Assistant Fixing Plan Phase 1B, Changes, Changes, Changes, Review / Verification, Review / Verification, Review / Verification, Technical Decision
...
Cohesion: 0.29
Nodes (7): 2026-05-13 Result — Phase 6.5 Provider Failure UX for AI Chat, Changes, Changes, Files Changed, Files Changed, Verification, Verification

### Community 576 - "Community 576"
Cohesion: 0.29
Nodes (7): 2026-05-12 Progress — AI Assistant Fixing Plan Phase 1C, Changes, Changes, Changes, Review / Verification, Review / Verification, Review / Verification
...
Cohesion: 0.7
Nodes (3): AiErrorDisplay(), extractStatus(), mapAiError()
...
Cohesion: 0.4
Nodes (5): 2026-05-12 Progress — Fix AI chat tool call pipeline and UX issues, Files Changed, Files Changed, Files Changed, Issues Fixed

### Community 667 - "Community 667"
Cohesion: 0.4
Nodes (5): 2026-05-13 Urgent Detour Result — Module Access 403 Trace, Changes, Next Step, Root Cause, Verification
...
Cohesion: 0.67
Nodes (3): 2026-05-11 Result — AI Settings UX Final Gaps (Subtasks 6 & 8), Subtask 6 — Profile Deprecation Endpoint, Subtask 8 — Restore Profile Reference on Reload
...
## Knowledge Gaps
- **3433 isolated node(s):** `MockHttpClient`, `Next Recommended Move`, `code:typescript (interface AiSetupWizardProps {)`, `Changes`, `Verification` (+3428 more)
...
- **Why does `Account` connect `Community 250` to `Community 291`, `Community 5`, `Community 44`, `Community 273`, `Community 20`, `Community 470`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `useCompanyAccess()` connect `Community 5` to `Community 162`, `Community 3`, `Community 4`, `Community 2`, `Community 36`, `Community 7`, `Community 329`, `Community 10`, `Community 11`, `Community 75`, `Community 13`, `Community 112`, `Community 213`, `Community 279`, `Community 187`, `Community 28`, `Community 30`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `FirestoreCompanyCreationSessionRepository` connect `Community 518` to `Community 9`, `Community 22`?**
...
- **What connects `MockHttpClient`, `Next Recommended Move`, `code:typescript (interface AiSetupWizardProps {)` to the rest of the system?**
