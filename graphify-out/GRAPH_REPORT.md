# Graph Report - ERP03  (2026-05-15)

## Corpus Check
- 1875 files · ~1,156,499 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14003 nodes · 23060 edges · 801 communities (542 shown, 259 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 402 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c7d18b73`
...
1. `Development Journal` - 299 edges
2. `useCompanyAccess()` - 92 edges
3. `ApiError` - 88 edges
4. `PermissionChecker` - 76 edges
5. `Button()` - 75 edges
6. `🎯 Current Focus` - 71 edges
...
## Communities (801 total, 259 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (77): ConsolidationController, RecurringVoucherController, formatUserDisplayName(), getUserAuditSnapshot(), VoucherSequenceController, PermissionChecker, MockPermissionChecker, GetAccountBalanceTool (+69 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (295): 2026-04-26 (Sat) — 2h, 2026-04-26 (Sat) — Session 0: Process Setup, 2026-04-27 (Mon) — 0.1h, 2026-04-27 (Mon) — 0.2h, 2026-04-27 (Mon) — 0.2h, 2026-04-27 (Mon) — 0.2h, 2026-04-27 (Mon) — 0.2h, 2026-04-27 (Mon) — 0.2h (+287 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (71): formatCompanyDate(), loadHistory(), handleSubmit(), handleSubmit(), formatCompanyDate(), useCompanySettings(), handleAction(), handleSave() (+63 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (69): setupErrorInterceptor(), handleExpireCertification(), handleRecordManualCert(), handleRunShellCert(), loadCertifications(), SuperAdminHeader(), SuperAdminPage(), SuperAdminPanel() (+61 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (78): handleClose(), handleRunDiagnostics(), useAccounts(), useCompanyModules(), load(), unwrap(), load(), unwrap() (+70 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (23): PrismaAiSettingsRepository, FirebaseTokenVerifier, PrismaCurrencyRepository, PrismaCompanySettingsRepository, AesEncryptionService, CompanySettingsDTOMapper, CompanySettings, getPrismaClient() (+15 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (43): Item, toDate(), StockLevel, toDate(), StockMovement, toDate(), roundMoney(), addDefaultContext() (+35 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (46): RequirePermission(), DocumentDesigner(), handleDelete(), handleEdit(), isProtected(), handleClickOutside(), getCoreFieldIds(), handleBack() (+38 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (22): MockTool, MockSuccessTool, MockHttpClient, SequenceHttpClient, AiAssistantDTOMapper, isAiCertificationCategory(), AiModelCertificationResult, AiModelProfile (+14 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (54): setAuthTokenGetter(), setCompanyIdGetter(), FirebaseAuthProvider, getFirebaseAuthProvider(), mapFirebaseUser(), ProtectedRoute(), RequireAuth(), RequireModule() (+46 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (50): GoodsReceipt, roundMoney(), toDate(), normalizeDocumentSource(), PurchaseInvoice, roundMoney(), toDate(), PurchaseOrder (+42 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (39): NewCompanyCard(), loadOptions(), WizardNavigation(), useWizardSession(), useCompanyBundles(), useCompanyFeatures(), useCompanyModules(), useCompanyProfile() (+31 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (21): PrismaAiUsageLogRepository, AiChatMessage, AiUsageLog, ProviderProviderError, AiConversationCleanupService, AiCredentialResolver, AiModelCapabilityCatalog, AiModelRoutingGuard (+13 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (22): AccountingDesignerController, FirestoreAiCreditLedgerRepository, stripUndefinedDeep(), AiCreditLedger, ApiError, permissionGuard(), handleStream(), DeleteCompanyRoleUseCase (+14 more)
...
Cohesion: 0.03
Nodes (31): ItemCategory, StockAdjustment, toDate(), StockTransfer, toDate(), toDate(), Uom, FirestoreInventorySettingsRepository (+23 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (25): ItemCardWindow(), ItemMasterCard(), PartyCardWindow(), handleAutoGenerateCode(), handleSave(), loadParty(), WarehouseCardWindow(), WarehouseMasterCard() (+17 more)
...
Cohesion: 0.03
Nodes (12): buildDraftVoucher(), buildLines(), VoucherEntity, moneyEquals(), ApprovalPolicyService, ConfirmCustodyUseCase, GenerateFXRevaluationVoucherUseCase, SubmitVoucherUseCase (+4 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (43): useAccountingSettings(), evaluateMathExpression(), handleBlur(), CurrencyDropdown(), fetchSystemRate(), handleRefresh(), run(), cleanFieldLabel() (+35 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (38): roundMoney(), SalesOrder, toDate(), SalesSettings, PrismaSalesSettingsRepository, makeCustomer(), makeItem(), makePostedInvoice() (+30 more)
...
Cohesion: 0.06
Nodes (27): DeliveryNote, roundMoney(), toDate(), normalizeDocumentSource(), roundMoney(), SalesInvoice, toDate(), toDisplayText() (+19 more)
...
Cohesion: 0.05
Nodes (12): FirestoreChartOfAccountsTemplateRepository, FirestoreInventoryTemplateRepository, PrismaChartOfAccountsTemplateRepository, PrismaInventoryTemplateRepository, CompanyGroup, InfrastructureError, GetAvailableCompanyModelsUseCase, GetNextWizardStepUseCase (+4 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (18): VoucherLineEntity, JournalEntryHandler, PaymentVoucherHandler, ReceiptVoucherHandler, FXRevaluationStrategy, JournalEntryStrategy, OpeningBalanceStrategy, PaymentVoucherStrategy (+10 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (15): FirestoreFiscalYearRepository, toDomain(), toPersistence(), FiscalYear, AppError, AuthError, BusinessError, InfrastructureError (+7 more)
...
Cohesion: 0.07
Nodes (21): AuthPermissionsController, CompanyCapabilityEntity, tenantContextMiddleware(), buildRegistryIndexes(), getCapabilityBlockedReason(), isCapabilityEntitled(), normalize(), normalizeList() (+13 more)
...
Cohesion: 0.06
Nodes (10): PermissionCatalogSyncService, deriveModuleBundlesFromPermissions(), PermissionRegistryController, CreateCompanyRoleUseCase, CreatePermissionUseCase, DeletePermissionUseCase, GetCompanyRoleUseCase, ListPermissionsUseCase (+2 more)

### Community 32 - "Community 32"
Cohesion: 0.06
Nodes (17): PaymentHistory, roundMoney(), toDate(), toStr(), FirestorePaymentHistoryRepository, toDate(), toTimestamp(), getSharedCollection() (+9 more)
...
Cohesion: 0.06
Nodes (12): InventorySettings, toDate(), Warehouse, PrismaInventorySettingsRepository, ConfigureInventoryFinancialIntegrationUseCase, InitializeInventoryUseCase, CreateWarehouseUseCase, GetWarehouseUseCase (+4 more)

### Community 35 - "Community 35"
Cohesion: 0.07
Nodes (7): TrialBalanceTool, getExecutableDefinitions(), AiAuditService, AiRuntimeGuard, AiToolCallingOrchestrator, AiToolRegistry, ExecuteAiToolUseCase
...
Cohesion: 0.05
Nodes (22): toOptionalGRNStatus(), toOptionalNumber(), toOptionalPaymentStatus(), toOptionalPIStatus(), toOptionalPRStatus(), toOptionalStatus(), ListGoodsReceiptsUseCase, UpdateGoodsReceiptUseCase (+14 more)

### Community 39 - "Community 39"
Cohesion: 0.04
Nodes (50): 2026-05-09 Operational Detour — Tailscale Local Dev Access, 2026-05-09 Result — AI Model Management Backend Trust Foundation, 2026-05-09 Result — Responsiveness Fix Plan, 2026-05-10 Result — Canvas Dev 96-Cell Widget Layout Sandbox, 2026-05-10 Result — Emulator Data Restore and Export-Path Guardrail, 2026-05-10 Result — Graphify CLI Usability Fix, 2026-05-10 Result — Increment 2.5 Branch and Worktree Reconciliation, 2026-05-10 Result — Increment 3: Frontend AI Certification UI (+42 more)

### Community 40 - "Community 40"
Cohesion: 0.06
Nodes (5): FirestoreCompanyModuleRepository, PrismaCompanyModuleRepository, FirestoreCurrencyRepository, CompanyModuleEntity, ModuleActivationService
...
Cohesion: 0.05
Nodes (21): toOptionalDNStatus(), toOptionalNumber(), toOptionalPaymentStatus(), toOptionalSIStatus(), toOptionalSRStatus(), toOptionalStatus(), ListDeliveryNotesUseCase, UpdateDeliveryNoteUseCase (+13 more)

### Community 45 - "Community 45"
Cohesion: 0.07
Nodes (19): handleEnable(), loadMatrix(), fetchInverseRateSuggestion(), getDeviationColor(), handleCancelSave(), handleConfirmSave(), handleSubmit(), performSave() (+11 more)
...
Cohesion: 0.11
Nodes (9): AiCreditController, AiMaintenanceController, companyModuleGuard(), ownerOrPermissionGuard(), assertSuperAdmin(), authMiddleware(), companyContextMiddleware(), SystemController (+1 more)
...
Cohesion: 0.05
Nodes (9): CompanyBundleController, CompanyFeaturesController, CompanyProfileController, CompanyRolesController, CompanyUsersController, ListActiveCompanyFeaturesUseCase, ListCompanyFeaturesUseCase, ToggleFeatureFlagUseCase (+1 more)
...
Cohesion: 0.07
Nodes (9): registerAllModules(), runCapabilityStartupValidation(), runModuleStartupValidation(), runPermissionStartupValidation(), EntitlementService, ModuleRegistry, initServer(), ModuleAvailabilityController (+1 more)
...
Cohesion: 0.06
Nodes (9): CurrencyController, DetectRateDeviationService, GetSuggestedRateUseCase, SaveReferenceRateUseCase, DisableCurrencyForCompanyUseCase, EnableCurrencyForCompanyUseCase, ListCompanyCurrenciesUseCase, GetCurrencyUseCase (+1 more)
...
Cohesion: 0.08
Nodes (6): AccountingModule, AiAssistantModule, moduleInitializedGuard(), InventoryModule, PurchaseModule, SalesModule
...
Cohesion: 0.07
Nodes (5): AccountingBootstrapService, RolePermissionResolver, ModulePermissionsController, PermissionSyncService, SystemRoleController
...
Cohesion: 0.07
Nodes (29): 2026-05-12 Result — AI Assistant Fixing Plan Phase 1 Business Model Fix, 2026-05-12 Result — AI Assistant Fixing Plan Phase 2 Security Hardening, 2026-05-13 Result — Frontend Conversation History Sidebar, Changes, Changes, Completed Subtasks, Completed Subtasks, Completed Subtasks (+21 more)
...
Cohesion: 0.16
Nodes (15): seedDemoCompany(), run(), cloneValue(), cloneVoucherFormForCompany(), cloneVoucherTypeForCompany(), normalizeCode(), normalizeModule(), syncCompanyVoucherTemplatesFromSystem() (+7 more)

### Community 108 - "Community 108"
Cohesion: 0.14
Nodes (7): FieldDefinition, VoucherTypeDefinition, inferFieldClass(), lineField(), normalizeField(), PostingFieldExtractor, FieldDefinitionValidator
...
Cohesion: 0.08
Nodes (24): Changes — Subtask A: Backend Model Profile Runtime Config (3 files), Changes — Subtask B: Provider Default API Key (4 files), Changes — Subtask C: Chat Runtime API Key Fallback (1 file), Changes — Subtask D: Frontend Updates (5+ files), How to test:, Previous Focus — Fix Certification Failures + Add Provider API Key Management, Problem, Problem (+16 more)

### Community 139 - "Community 139"
Cohesion: 0.08
Nodes (24): 2026-05-12 Progress — AI Assistant Fixing Plan Phase 1D, 2026-05-12 Progress — AI Assistant Fixing Plan Phase 2A, 2026-05-13 Progress — AI Assistant Fixing Plan Phase 3A, Changes, Changes, Changes, Changes, Changes (+16 more)

### Community 140 - "Community 140"
Cohesion: 0.1
Nodes (24): 2026-05-13 Result — Phase 6.6 Simplified Tenant AI Setup Wizard, 2026-05-13 Result — Phase 6.6B Setup Wizard Integration, 2026-05-13 Result — Phase 7.1 Per-User AI Rate Limiting, Changes, Changes, Changes, Changes, Changes (+16 more)
...
Cohesion: 0.1
Nodes (4): AccountController, DeactivateAccountUseCase, GetAccountUseCase, ListAccountsUseCase
...
Cohesion: 0.15
Nodes (16): cancelOrder(), closeOrder(), confirmOrder(), createEmptyForm(), createEmptyLine(), ensureItemUomOptions(), load(), loadOrder() (+8 more)
...
Cohesion: 0.16
Nodes (8): handleNext(), handleSelect(), closeModal(), clsx(), useAuth(), cn(), handleContinue(), loadPlans()
...
Cohesion: 0.14
Nodes (6): UomConversion, UomConversionMapper, ManageUomConversionsUseCase, resolveConversionUom(), stripUndefined(), trimOrUndefined()
...
Cohesion: 0.1
Nodes (21): 2026-05-12 Progress — Fix AI chat tool call pipeline and UX issues, 2026-05-12 Progress — Super Admin Diagnostics Modal + UX Refactor, Changes, Changes, Changes, Changes, Changes, Detour Fix — Silent Mock Fallback in Diagnostics (+13 more)

### Community 165 - "Community 165"
Cohesion: 0.1
Nodes (21): 2026-05-13 Result — Phase 4.2 Broader Intent Keywords, 2026-05-13 Result — Phase 6.5 Provider Failure UX for AI Chat, Changes, Changes, Changes, Changes, Changes, Changes (+13 more)
...
Cohesion: 0.13
Nodes (5): CompanyModuleSettingsController, DesignerController, VoucherTypeController, permissionsMiddleware(), ModuleSettingsValidator
...
Cohesion: 0.1
Nodes (20): ✅ 2026-05-08 Result, Detour: AI Chat 30s Timeout, Detour: Frontend Ngrok Host Allowlist, Files Changed By This Task, Follow-up: AI Settings Model Diagnostics, Follow-up: Conversation Context Cost Settings, Follow-up: Conversation Context First Rules, Follow-up: Editable AI Model Profiles (+12 more)
...
Cohesion: 0.15
Nodes (3): CreateAccountUseCase, DeleteAccountUseCase, UpdateAccountUseCase
...
Cohesion: 0.11
Nodes (19): Changes:, Changes:, Changes:, Changes:, Changes:, Changes:, Changes:, Changes: (+11 more)
...
Cohesion: 0.15
Nodes (6): findGRNLine(), findPILine(), findPOLine(), PostPurchaseReturnUseCase, recalcReturnTotals(), UpdatePurchaseReturnUseCase
...
Cohesion: 0.13
Nodes (3): AiStreamError, QuickActionButtons(), handleNewConversation()
...
Cohesion: 0.14
Nodes (14): 2026-05-12 Progress — AI Assistant Fixing Plan Phase 1A, Changes, Changes, Changes, Changes, Rabbit Holes Logged, Rabbit Holes Logged, Rabbit Holes Logged (+6 more)
...
Cohesion: 0.15
Nodes (12): 10. Item Extension for Sales Accounts, 1. Architecture, 6.1 Company-Level Sales Settings, 6. Settings Design, 8. Shared Services Reuse, 9. V1 Scope, code:typescript (// ADD to existing ItemProps:), ❌ Deferred (+4 more)

### Community 324 - "Community 324"
Cohesion: 0.27
Nodes (4): handleSubmit(), validate(), handleCreate(), StepSuccess()
...
Cohesion: 0.17
Nodes (12): 2026-05-12 Progress — AI Assistant Fixing Plan Phase 1B, Changes, Changes, Changes, Changes, Changes, Review / Verification, Review / Verification (+4 more)
...
Cohesion: 0.22
Nodes (5): parseSSEEvent(), streamMessage(), getAuthToken(), getCompanyId(), fetchBalance()
...
Cohesion: 0.18
Nodes (11): 2026-05-12 Progress — AI Assistant Fixing Plan Phase 1C, Changes, Changes, Changes, Changes, Changes, Review / Verification, Review / Verification (+3 more)
...
Cohesion: 0.22
Nodes (9): 2026-05-13 Result — AI Assistant Fixing Plan Phase 3B/3C Tool Truncation Signals, Changes, Changes, Changes, Documentation, Documentation, Verification, Verification (+1 more)

### Community 475 - "Community 475"
Cohesion: 0.22
Nodes (9): 2026-05-13 Urgent Detour Result — Module Access 403 Trace, Changes, Changes, Changes, Next Step, Root Cause, Verification, Verification (+1 more)
...
Cohesion: 0.67
Nodes (3): handleEnter(), setUiMode(), handleEnter()
...
## Knowledge Gaps
- **3622 isolated node(s):** `MockHttpClient`, `🛠️ Recent Fixes (AI Assistant Tooling & Stabilization)`, `Phase 1A Progress`, `Subtasks Completed`, `Remaining Gap (PARTIAL)` (+3617 more)
...
- **Why does `Account` connect `Community 237` to `Community 0`, `Community 9`, `Community 299`, `Community 277`, `Community 26`, `Community 187`, `Community 446`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `NewVoucherFormsDemo()` connect `Community 9` to `Community 237`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `useCompanyAccess()` connect `Community 9` to `Community 33`, `Community 2`, `Community 4`, `Community 37`, `Community 7`, `Community 41`, `Community 170`, `Community 11`, `Community 137`, `Community 45`, `Community 16`, `Community 19`, `Community 180`, `Community 21`, `Community 149`, `Community 55`?**
...
- **What connects `MockHttpClient`, `🛠️ Recent Fixes (AI Assistant Tooling & Stabilization)`, `Phase 1A Progress` to the rest of the system?**
