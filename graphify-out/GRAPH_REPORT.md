# Graph Report - ERP03  (2026-05-13)

## Corpus Check
- 1860 files · ~1,146,826 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 13768 nodes · 22674 edges · 823 communities (565 shown, 258 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 390 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e0efa00a`
...
1. `Development Journal` - 280 edges
2. `useCompanyAccess()` - 91 edges
3. `ApiError` - 86 edges
...
## Communities (823 total, 258 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (276): 2026-04-26 (Sat) — 2h, 2026-04-26 (Sat) — Session 0: Process Setup, 2026-04-27 (Mon) — 0.1h, 2026-04-27 (Mon) — 0.2h, 2026-04-27 (Mon) — 0.2h, 2026-04-27 (Mon) — 0.2h, 2026-04-27 (Mon) — 0.2h, 2026-04-27 (Mon) — 0.2h (+268 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (62): handleEnable(), formatCompanyDate(), loadHistory(), loadMatrix(), handleSubmit(), fetchInverseRateSuggestion(), getDeviationColor(), handleCancelSave() (+54 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (40): GetAccountBalanceTool, round2(), GetAccountStatementSummaryTool, round2(), GetAgingPayablesTool, round2(), GetAgingReceivablesTool, round2() (+32 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (28): ConsolidationController, formatUserDisplayName(), getUserAuditSnapshot(), VoucherSequenceController, Budget, PermissionChecker, MockPermissionChecker, AssignRoleToCompanyUserUseCase (+20 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (64): handleAutoGenerateCode(), handleSave(), loadParty(), handleClose(), handleSubmit(), useAccounts(), useCompanyModules(), useDocumentPolicies() (+56 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (33): setAuthTokenGetter(), setCompanyIdGetter(), setupErrorInterceptor(), RequireAuth(), RequireModule(), RequireOnboarding(), SuperAdminRedirect(), PageTitleManager() (+25 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (44): DeliveryNote, roundMoney(), toDate(), Item, toDate(), roundMoney(), SalesOrder, toDate() (+36 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (56): ProtectedRoute(), ItemMasterCard(), WarehouseMasterCard(), handleAction(), handleSave(), createEmptyForm(), createEmptyLine(), todayIso() (+48 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (21): NewCompanyCard(), loadOptions(), WizardNavigation(), useWizardSession(), useCompanyBundles(), useCompanyFeatures(), useCompanyModules(), useCompanyProfile() (+13 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (17): FirebaseTokenVerifier, PrismaChartOfAccountsTemplateRepository, PrismaCurrencyRepository, PrismaInventoryTemplateRepository, AesEncryptionService, DesignerController, getPrismaClient(), PrismaTransactionManager (+9 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (14): MockTool, MockSuccessTool, PrismaAiSettingsRepository, MockHttpClient, SequenceHttpClient, AiProviderConfig, ProviderAuthError, ProviderError (+6 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (38): GoodsReceipt, roundMoney(), toDate(), normalizeDocumentSource(), PurchaseInvoice, roundMoney(), toDate(), PurchaseOrder (+30 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (30): Party, toDate(), TaxCode, toDate(), PartyMapper, stripUndefinedDeep(), TaxCodeMapper, toDate() (+22 more)
...
Cohesion: 0.05
Nodes (21): StockAdjustment, toDate(), StockLevel, toDate(), StockMovement, toDate(), StockTransfer, toDate() (+13 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (39): load(), unwrap(), load(), unwrap(), load(), unwrap(), load(), unwrap() (+31 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (12): FirestoreCompanyAdminRepository, CompanyController, PostgresCompanyRepository, CoreDTOMapper, Company, CompanyPgMapper, EnableModuleForCompanyUseCase, GetCompanyDetailsUseCase (+4 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (17): useVoucherTypeDefinition(), canonicalToUi(), transformCanonicalLayout(), transformLayout(), uiToCanonical(), validateUiConfig(), loadVoucherForms(), CustomerAccountSelector() (+9 more)
...
Cohesion: 0.05
Nodes (23): AuthPermissionsController, CompanyModulesController, CompanyCapabilityEntity, tenantContextMiddleware(), buildRegistryIndexes(), getCapabilityBlockedReason(), isCapabilityEntitled(), normalize() (+15 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (12): AiCreditController, CompanySettingsController, VoucherTypeController, moduleInitializedGuard(), permissionGuard(), assertSuperAdmin(), authMiddleware(), companyContextMiddleware() (+4 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (19): AccountingDTOMapper, VoucherLineEntity, OpeningBalanceHandler, PaymentVoucherHandler, ReceiptVoucherHandler, FXRevaluationStrategy, JournalEntryStrategy, OpeningBalanceStrategy (+11 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (18): ItemCardWindow(), PartyCardWindow(), WarehouseCardWindow(), useActiveBreakpoint(), useBreakpoint(), useDocumentActions(), useUiMode(), useUserPreferences() (+10 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (13): AccountingDesignerController, CompanyModulesController, mapDto(), UserPreferencesController, ApiError, companyModuleGuard(), ownerOrPermissionGuard(), DisableCompanyUserUseCase (+5 more)
...
Cohesion: 0.06
Nodes (20): ItemCategory, OpeningStockDocument, toDate(), InventoryPeriodSnapshotMapper, InventorySettingsMapper, ItemCategoryMapper, ItemMapper, OpeningStockDocumentMapper (+12 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (26): AppError, AuthError, BusinessError, InfrastructureError, ValidationError, VoucherPostingStrategyFactory, makePostedVoucher(), makeVoucher() (+18 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (9): TrialBalanceTool, getCatalogDefinition(), getExecutableDefinitions(), AiAuditService, certificationCategoryForModule(), AiRuntimeGuard, AiToolCallingOrchestrator, AiToolRegistry (+1 more)
...
Cohesion: 0.05
Nodes (19): PaymentHistory, roundMoney(), toDate(), toStr(), normalizeDocumentSource(), roundMoney(), SalesInvoice, toDate() (+11 more)
...
Cohesion: 0.05
Nodes (31): handleNew(), handleRateDeviationConfirm(), handleRateDeviationSync(), handleSaveVoucher(), normalizeSemanticPayload(), performSave(), format(), formatCompact() (+23 more)

### Community 34 - "Community 34"
Cohesion: 0.06
Nodes (19): cn(), clearLogo(), handleFileChange(), handleSubmit(), validate(), handleNext(), handleSelect(), handleSubmit() (+11 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (8): OnboardingController, EntitlementService, CompanyRolePermissionResolver, FirestoreBundleItemRepository, CreateCompanyUseCase, GetOnboardingStatusUseCase, SelectPlanUseCase, SignupUseCase

### Community 36 - "Community 36"
Cohesion: 0.08
Nodes (11): AiModelCertificationResult, AiModelProfile, AiAutoSeedCertification, AiCertificationEngine, evaluateResponse(), evaluateShouldAnswerFromData(), evaluateShouldRefuse(), evaluateShouldRefuseOrProposeDraft() (+3 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (7): AccountingBootstrapService, RolePermissionResolver, FirestoreModulePermissionsDefinitionRepository, ModulePermissionsController, PermissionSyncService, PrismaModulePermissionsDefinitionRepository, SystemRoleController

### Community 38 - "Community 38"
Cohesion: 0.06
Nodes (7): FirestoreAiChatRepository, stripUndefinedDeep(), PrismaAiChatRepository, PrismaAiUsageLogRepository, AiChatMessage, AiUsageLog, AiResponsePersister
...
Cohesion: 0.06
Nodes (7): FirestoreBudgetRepository, toTimestamp(), FirestoreChartOfAccountsTemplateRepository, FirestoreCompanyWizardTemplateRepository, FirestoreInventoryTemplateRepository, InfrastructureError, FirestoreCompanyModuleSettingsRepository

### Community 41 - "Community 41"
Cohesion: 0.07
Nodes (5): FirestoreAiModelToolPolicyRepository, AiModelToolPolicy, AiToolDefinition, modeToOperationType(), AiToolEnablementPolicy
...
Cohesion: 0.05
Nodes (21): toOptionalGRNStatus(), toOptionalNumber(), toOptionalPaymentStatus(), toOptionalPIStatus(), toOptionalPRStatus(), toOptionalStatus(), GetGoodsReceiptUseCase, GetPurchaseInvoiceUseCase (+13 more)
...
Cohesion: 0.08
Nodes (20): buildItemUomSelections(), convertItemQtyToBaseUom(), convertItemQtyToBaseUomDetailed(), dedupeSelections(), findMatchingItemUomSelection(), getDefaultItemUomSelection(), normalizeCode(), resolveItemUomSelection() (+12 more)
...
Cohesion: 0.07
Nodes (9): FeatureFlagService, BundleRegistryController, CreateBundleUseCase, DeleteBundleUseCase, GetCompanyBundleUseCase, ListAvailableBundlesUseCase, ListBundlesUseCase, UpdateBundleUseCase (+1 more)
...
Cohesion: 0.07
Nodes (19): PurchaseSettings, makeGRN(), makeItem(), makePI(), makePO(), makeTaxCode(), makeVendor(), nowDate() (+11 more)
...
Cohesion: 0.1
Nodes (11): FieldDefinition, FormDefinition, VoucherTypeDefinition, FormDefinitionMapper, VoucherTypeDefinitionMapper, inferFieldClass(), lineField(), normalizeField() (+3 more)

### Community 55 - "Community 55"
Cohesion: 0.07
Nodes (3): AiToolCatalogController, isAiCertificationCategory(), AiModelCertificationUseCase

### Community 56 - "Community 56"
Cohesion: 0.08
Nodes (8): FirestoreBankStatementRepository, toTimestamp(), FirestoreReconciliationRepository, toTimestamp(), BankStatement, Reconciliation, MemoryBankRepo, MemoryReconciliationRepo
...
Cohesion: 0.07
Nodes (11): RequirePermission(), handleDelete(), handleEdit(), isProtected(), handleClickOutside(), handleDelete(), handleEdit(), isProtected() (+3 more)

### Community 63 - "Community 63"
Cohesion: 0.08
Nodes (28): ModuleStatusBanner(), documentUiToCanonical(), transformLayout(), detectDocumentKind(), getFormIdentityValues(), init(), loadDocumentRows(), loadResolvableForms() (+20 more)
...
Cohesion: 0.06
Nodes (9): FirestoreCompanyUserRepository, PrismaCompanyUserRepository, CompanyUser, CompanyMapper, CompanyUserMapper, UserMapper, AssignRoleToCompanyUserUseCase, GetUserCompaniesUseCase (+1 more)
...
Cohesion: 0.09
Nodes (10): toDate(), Uom, toDate(), Warehouse, InMemoryWarehouseRepository, CreateWarehouseUseCase, GetWarehouseUseCase, normalizeParentId() (+2 more)
...
Cohesion: 0.09
Nodes (25): confirmAddSpecialPeriod(), confirmClosePeriod(), confirmCloseYear(), confirmDeleteYear(), confirmReopenPeriod(), confirmReopenYear(), handleAutoCreateRetainedEarnings(), handleClosePeriod() (+17 more)
...
Cohesion: 0.09
Nodes (19): roundMoney(), SalesReturn, toDate(), FirestoreSalesSettingsRepository, getSalesCollection(), getSalesDataRef(), getSalesModuleRef(), getSalesSettingsRef() (+11 more)
...
Cohesion: 0.07
Nodes (17): toOptionalDNStatus(), toOptionalNumber(), toOptionalPaymentStatus(), toOptionalSIStatus(), toOptionalSRStatus(), toOptionalStatus(), ListDeliveryNotesUseCase, GetSalesInvoiceUseCase (+9 more)

### Community 89 - "Community 89"
Cohesion: 0.08
Nodes (7): User, SuperAdminController, DemoteSuperAdminUseCase, GetSystemOverviewUseCase, ListAllCompaniesUseCase, ListAllUsersUseCase, PromoteUserToSuperAdminUseCase
...
Cohesion: 0.06
Nodes (34): 2026-05-08 Settings Diagnostics Update, 2026-05-08 Update, 2026-05-09 Context Budget and Cost Controls, 2026-05-09 Conversation Context Update, 2026-05-09 Editable Model Profile Catalog, AI Assistant Runtime v2 Architecture, Backend Trust Foundation: Provider -> Profile -> Certification -> Routing, Certification Engine Shell (+26 more)
...
Cohesion: 0.09
Nodes (9): Role, AuditLogMapper, ModuleMapper, NotificationMapper, PermissionMapper, RoleMapper, FirestoreAuditLogRepository, FirestorePermissionRepository (+1 more)
...
Cohesion: 0.12
Nodes (27): deepMergeObjects(), dispatchUpdate(), firstDisplayText(), firstEntityRef(), isPlainObject(), resolveDocumentSource(), sanitizeMetadata(), sanitizeSourceSnapshot() (+19 more)

### Community 101 - "Community 101"
Cohesion: 0.1
Nodes (22): cancelOrder(), closeOrder(), confirmOrder(), createEmptyForm(), createEmptyLine(), deleteDraft(), ensureItemUomOptions(), load() (+14 more)
...
Cohesion: 0.1
Nodes (10): assertValidSalesTaxCode(), CreateSalesInvoiceUseCase, findSOLine(), hasNativeLinkedSalesSource(), normalizeSalesInvoiceToken(), PostSalesInvoiceUseCase, resolveDocumentSource(), resolveSalesInvoiceFormType() (+2 more)
...
Cohesion: 0.11
Nodes (3): SettingsController, FirestoreCurrencyRepository, SettingsResolver
...
Cohesion: 0.13
Nodes (14): SuperAdminHeader(), SuperAdminTable(), useSuperAdminTable(), handleDelete(), handleSubmit(), loadPermissions(), handleDelete(), handleSubmit() (+6 more)
...
Cohesion: 0.12
Nodes (7): AiAssistantDTOMapper, handleStream(), AiSettingsUseCase, ExecuteAiToolUseCase, GetUsageAnalyticsUseCase, validateSendChatMessageInput(), validateUpdateAiSettingsInput()

### Community 137 - "Community 137"
Cohesion: 0.11
Nodes (4): FirestoreFiscalYearRepository, toDomain(), toPersistence(), FiscalYear

### Community 138 - "Community 138"
Cohesion: 0.13
Nodes (7): SuperAdminPage(), SuperAdminPanel(), SuperAdminStatCard(), addPermission(), handleDrop(), handleCreate(), loadRoles()
...
Cohesion: 0.13
Nodes (4): InventorySettings, FirestoreInventorySettingsRepository, getInventorySettingsRef(), ConfigureInventoryFinancialIntegrationUseCase
...
Cohesion: 0.09
Nodes (25): 2026-05-12 Progress — AI Assistant Fixing Plan Phase 1D, 2026-05-12 Progress — AI Assistant Fixing Plan Phase 2A, 2026-05-13 Progress — AI Assistant Fixing Plan Phase 3A, 2026-05-13 Result — Phase 6.6 Simplified Tenant AI Setup Wizard, Changes, Changes, Changes, Changes (+17 more)
...
Cohesion: 0.1
Nodes (4): EntitlementServiceAdapter, SuperAdminEntitlementsController, GrantModuleToCompanyUseCase, RevokeModuleFromCompanyUseCase
...
Cohesion: 0.21
Nodes (12): cloneValue(), cloneVoucherFormForCompany(), cloneVoucherTypeForCompany(), normalizeCode(), normalizeModule(), syncCompanyVoucherTemplatesFromSystem(), canonicalizeVoucherCode(), dedupeVoucherForms() (+4 more)
...
Cohesion: 0.09
Nodes (22): Changes — Subtask A: Backend Model Profile Runtime Config (3 files), Changes — Subtask B: Provider Default API Key (4 files), Changes — Subtask C: Chat Runtime API Key Fallback (1 file), Changes — Subtask D: Frontend Updates (5+ files), How to test:, Previous Focus — Fix Certification Failures + Add Provider API Key Management, Problem, Problem (+14 more)
...
Cohesion: 0.1
Nodes (21): 2026-05-12 Progress — AI Assistant Fixing Plan Phase 1A, 2026-05-12 Progress — AI Assistant Fixing Plan Phase 1B, Changes, Changes, Changes, Changes, Changes, Changes (+13 more)

### Community 179 - "Community 179"
Cohesion: 0.11
Nodes (21): 2026-05-12 Result — AI Assistant Fixing Plan Phase 1 Business Model Fix, 2026-05-12 Result — AI Assistant Fixing Plan Phase 2 Security Hardening, 2026-05-13 Result — Phase 6.6B Setup Wizard Integration, Completed Subtasks, Completed Subtasks, Completed Subtasks, Completed Subtasks, Detours (+13 more)
...
Cohesion: 0.17
Nodes (3): ManagementInsightProposalGenerator, ReorderProposalGenerator, VoucherDraftProposalGenerator
...
Cohesion: 0.19
Nodes (13): run(), runSystemSeeder(), seedBundles(), seedBusinessDomains(), seedCompanyRoles(), seedModuleDefinitions(), seedModulesRegistry(), seedOnboardingData() (+5 more)
...
Cohesion: 0.11
Nodes (19): ✅ 2026-05-08 Result, Detour: AI Chat 30s Timeout, Detour: Frontend Ngrok Host Allowlist, Files Changed By This Task, Follow-up: AI Settings Model Diagnostics, Follow-up: Conversation Context Cost Settings, Follow-up: Conversation Context First Rules, Follow-up: Editable AI Model Profiles (+11 more)
...
Cohesion: 0.11
Nodes (18): Changes:, Changes:, Changes:, Changes:, Changes:, Changes:, Changes:, Changes: (+10 more)
...
Cohesion: 0.12
Nodes (17): 2026-05-12 Progress — Fix AI chat tool call pipeline and UX issues, 2026-05-12 Progress — Super Admin Diagnostics Modal + UX Refactor, Changes, Changes, Changes, Changes, Detour Fix — Silent Mock Fallback in Diagnostics, Files Changed (+9 more)
...
Cohesion: 0.12
Nodes (15): Acceptance Criteria, code:text (backend implementation exists), code:text (platform_only), code:text (platform_only: only SuperAdmin can grant/enable for a compan), code:text (1. Capability exists in DB.), code:text (Entitled = company is allowed to use something.), code:text (Is company entitled to crm.ai-scoring?), code:text (Company Admin module list does not read raw code registry.) (+7 more)
...
Cohesion: 0.15
Nodes (5): handleClose(), handleRunDiagnostics(), handleDelete(), handleSubmit(), loadDomains()
...
Cohesion: 0.13
Nodes (14): AI Assistant Runtime v2 — User Guide, AI Proposals, Certification Workflows, Certified Model Safety, Controlling Context Cost, Follow-Up Questions, How to Use It, How Tool Planning Works (+6 more)
...
Cohesion: 0.15
Nodes (13): 2026-05-13 Result — Phase 6.5 Provider Failure UX for AI Chat, Changes, Changes, Changes, Changes, Files Changed, Files Changed, Files Changed (+5 more)
...
Cohesion: 0.18
Nodes (11): Changes, Changes, Changes, Changes, Current Focus — Correct Credential/Provider Design (runtimeMode + platformRuntimeCredential), Design Rules Enforced:, Problem, Verification: (+3 more)
...
Cohesion: 0.22
Nodes (9): 2026-05-12 Progress — AI Assistant Fixing Plan Phase 1C, Changes, Changes, Changes, Changes, Review / Verification, Review / Verification, Review / Verification (+1 more)
...
Cohesion: 0.22
Nodes (8): AI Provider-driven Settings Architecture, code:txt (AiProvider), code:txt (GET /tenant/ai-assistant/providers), Data model, Decision, Follow-up architecture work, Runtime safety, Tenant-safe endpoints
...
Cohesion: 0.36
Nodes (3): seedDemoCompany(), run(), InitializeAccountingUseCase
...
Cohesion: 0.29
Nodes (7): evaluateMathExpression(), getCellKey(), handleAmountBlur(), handleAmountKeyDown(), handleCellKeyDown(), handleRowChange(), registerCellRef()
...
Cohesion: 0.43
Nodes (4): handleExpireCertification(), handleRecordManualCert(), handleRunShellCert(), loadCertifications()
...
Cohesion: 0.29
Nodes (7): 2026-05-13 Urgent Detour Result — Module Access 403 Trace, Changes, Changes, Next Step, Root Cause, Verification, Verification
...
Cohesion: 0.29
Nodes (6): AI Provider Settings, Certified models, How to configure AI, Provider types, Safety notes, What changed
...
Cohesion: 0.33
Nodes (6): 2026-05-13 Result — AI Assistant Fixing Plan Phase 3B/3C Tool Truncation Signals, Changes, Changes, Documentation, Verification, Verification
...
## Knowledge Gaps
- **3494 isolated node(s):** `MockHttpClient`, `Next Recommended Move`, `Verification`, `Changes`, `Verification` (+3489 more)
...
- **Why does `FirestoreCompanyCreationSessionRepository` connect `Community 519` to `Community 40`, `Community 9`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `normalizeDate()` connect `Community 1` to `Community 519`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `useCompanyAccess()` connect `Community 5` to `Community 128`, `Community 1`, `Community 33`, `Community 34`, `Community 4`, `Community 101`, `Community 100`, `Community 7`, `Community 321`, `Community 8`, `Community 75`, `Community 17`, `Community 22`, `Community 154`, `Community 59`, `Community 28`, `Community 62`, `Community 63`?**
...
- **What connects `MockHttpClient`, `Next Recommended Move`, `Verification` to the rest of the system?**
