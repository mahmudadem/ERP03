# Graph Report - ERP03  (2026-05-30)

## Corpus Check
- 2186 files · ~1,481,988 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19770 nodes · 31099 edges · 1111 communities (870 shown, 241 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 1030 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `66aed1b9`
...
10. `InventoryController` - 63 edges
...
## Communities (1111 total, 241 thin omitted)
...
Cohesion: 0.01
Nodes (37): AccountingBootstrapService, toTimestamp(), FirebaseTokenVerifier, FirestoreChartOfAccountsTemplateRepository, FirestoreCompanyWizardTemplateRepository, FirestoreCurrencyRepository, FirestoreInventoryTemplateRepository, PrismaChartOfAccountsTemplateRepository (+29 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (62): PermissionChecker, GetAccountBalanceTool, round2(), GetAccountStatementSummaryTool, round2(), GetAgingPayablesTool, round2(), GetAgingReceivablesTool (+54 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (69): NewCompanyCard(), loadOptions(), WizardNavigation(), useWizardSession(), useCompanyBundles(), useCompanyFeatures(), useCompanyModules(), useCompanyProfile() (+61 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (33): AccountController, AccountingDesignerController, BankReconciliationController, ConsolidationController, FiscalYearController, RecurringVoucherController, ReportingController, VoucherSequenceController (+25 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (65): GoodsReceipt, roundMoney(), toDate(), Item, toDate(), normalizeDocumentSource(), PurchaseInvoice, roundMoney() (+57 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (56): formatCompanyDate(), loadHistory(), addRow(), applyAIData(), copyToClipboard(), handleAIAutoFill(), handleImageImport(), handleInputChange() (+48 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (45): InventorySettings, StockLevel, toDate(), StockMovement, toDate(), NegativeStockError, addDefaultContext(), createCompany() (+37 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (82): AccountsProvider(), useAccounts(), useCompanyModules(), confirmRejection(), handleRefresh(), handleSave(), InventorySettingsPage(), load() (+74 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (59): useAccountingSettings(), useCompanyCurrencies(), transformLayout(), uiToCanonical(), buildCreateSeed(), getCreateErrorMessage(), handleCreateItem(), handleInputBlur() (+51 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (44): PromotionRule, Quote, toDate(), SalesSettings, PrismaSalesSettingsRepository, makeCustomer(), makeItem(), nowDate() (+36 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (27): CompanyController, CoreDTOMapper, Company, CompanyUser, User, CompanyMapper, CompanyUserMapper, UserMapper (+19 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (50): clamp(), clampSpan(), findFirstAvailableSpace(), getBorderClassForWidget(), getWidgetEnd(), handleDragEnd(), hasCollision(), moveWidget() (+42 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (48): RequirePermission(), DocumentDesigner(), handleDelete(), handleEdit(), isProtected(), handleClickOutside(), ModuleStatusBanner(), handleDelete() (+40 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (42): setAuthTokenGetter(), setCompanyIdGetter(), ProtectedRoute(), RequireAuth(), RequireModule(), RequireOnboarding(), SuperAdminRedirect(), PageTitleManager() (+34 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (33): InventoryPeriodSnapshot, toDate(), ItemCategory, StockAdjustment, toDate(), StockTransfer, toDate(), UomConversion (+25 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (23): AiMaintenanceController, CompanyModulesController, RecordAuditController, ApiError, companyModuleGuard(), moduleInitializedGuard(), ownerOrPermissionGuard(), permissionGuard() (+15 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (63): fetchData(), fetchLogs(), handleClose(), handleSubmit(), handleClose(), handleRunDiagnostics(), handleSubmit(), load() (+55 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (19): AccountingModule, AiAssistantModule, InventoryModule, registerAllModules(), runCapabilityStartupValidation(), runModuleStartupValidation(), runPermissionStartupValidation(), EntitlementServiceAdapter (+11 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (52): PurchaseDTOMapper, PurchasesInventoryService, GetGoodsReceiptUseCase, ListGoodsReceiptsUseCase, UpdateGoodsReceiptUseCase, CreateAndPostPurchaseInvoiceUseCase, GetPurchaseInvoiceUseCase, ListPurchaseInvoicesUseCase (+44 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (42): DeliveryNote, roundMoney(), toDate(), roundMoney(), SalesOrder, toDate(), roundMoney(), SalesReturn (+34 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (60): Action, code:bash (git add -A), handleAction(), handleSave(), createEmptyForm(), createEmptyLine(), todayIso(), createEmptyForm() (+52 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (24): FiscalYear, AppError, AuthError, BusinessError, InfrastructureError, ValidationError, MockPermissionChecker, FiscalPeriodGenerator (+16 more)

### Community 23 - "Community 23"
Cohesion: 0.04
Nodes (43): AccountMappingError, createAggregatedPolicyError(), createPostingError(), PostingError, PersonaNotAllowedError, UnsettledCostError, buildSalesReturnUseCases(), ensureDirectPersonaAllowed() (+35 more)
...
Cohesion: 0.04
Nodes (23): AuthPermissionsController, CompanyCapabilityEntity, tenantContextMiddleware(), ModuleAvailabilityService, buildRegistryIndexes(), getCapabilityBlockedReason(), isCapabilityEntitled(), normalize() (+15 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (34): ItemCardWindow(), PartyCardWindow(), handleNew(), handleRateDeviationConfirm(), handleRateDeviationSync(), handleSaveVoucher(), normalizeSemanticPayload(), performSave() (+26 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (15): TrialBalanceTool, MockSuccessTool, ProviderProviderError, AiAuditService, AiContextBuilder, AiResponseSanitizer, AiRuntimeGuard, AiTenantContextResolver (+7 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (25): PaymentHistory, roundMoney(), toDate(), toStr(), calculateDiscountAmountDoc(), normalizeDiscountType(), normalizeDocumentSource(), roundMoney() (+17 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (7): MockTool, PrismaAiSettingsRepository, MockHttpClient, SequenceHttpClient, AiProviderConfig, ProviderFactory, AiRateLimiterService
...
Cohesion: 0.06
Nodes (18): roundMoney(), VoucherLineEntity, OpeningBalanceHandler, PaymentVoucherHandler, FXRevaluationStrategy, JournalEntryStrategy, OpeningBalanceStrategy, PaymentVoucherStrategy (+10 more)

### Community 32 - "Community 32"
Cohesion: 0.05
Nodes (39): getCoreFieldIds(), handleBack(), handleDragStartField(), handleDropField(), handleNext(), handleStepClick(), handleTemplateSelect(), moveSelectedFieldSection() (+31 more)
...
Cohesion: 0.07
Nodes (9): AiCreditController, FieldLibraryController, assertSuperAdmin(), authMiddleware(), companyContextMiddleware(), permissionsMiddleware(), NotificationController, SystemController (+1 more)

### Community 35 - "Community 35"
Cohesion: 0.05
Nodes (22): FirebaseAuthProvider, getFirebaseAuthProvider(), mapFirebaseUser(), handleFileChange(), closeModal(), AuthProvider(), useAuth(), processImage() (+14 more)
...
Cohesion: 0.05
Nodes (16): toDate(), Uom, toDate(), Warehouse, InMemoryWarehouseRepository, InitializeInventoryUseCase, CreateUomUseCase, GetUomUseCase (+8 more)

### Community 41 - "Community 41"
Cohesion: 0.06
Nodes (23): FirestorePostingLogRepository, fromTimestamp(), toTimestamp(), PostingLog, buildItemUomSelections(), convertItemQtyToBaseUom(), convertItemQtyToBaseUomDetailed(), dedupeSelections() (+15 more)

### Community 42 - "Community 42"
Cohesion: 0.06
Nodes (31): clsx(), generateVouchers(), randomItem(), deepMergeObjects(), dispatchUpdate(), firstDisplayText(), firstEntityRef(), isPlainObject() (+23 more)

### Community 43 - "Community 43"
Cohesion: 0.06
Nodes (14): DesignerDTOMapper, FieldDefinition, FormDefinition, VoucherTypeDefinition, FormDefinitionMapper, VoucherTypeDefinitionMapper, PostingFieldExtractor, AdoptTemplateUseCase (+6 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (16): CreditOverride, Party, toDate(), CreditLimitExceededError, PartyMapper, stripUndefinedDeep(), TaxCodeMapper, toDate() (+8 more)

### Community 45 - "Community 45"
Cohesion: 0.06
Nodes (8): EntitlementService, CreateBundleUseCase, DeleteBundleUseCase, GetCompanyBundleUseCase, ListAvailableBundlesUseCase, ListBundlesUseCase, UpdateBundleUseCase, UpgradeCompanyBundleUseCase
...
Cohesion: 0.09
Nodes (7): PurchaseController, toOptionalGRNStatus(), toOptionalNumber(), toOptionalPaymentStatus(), toOptionalPIStatus(), toOptionalPRStatus(), toOptionalStatus()
...
Cohesion: 0.07
Nodes (8): PermissionCatalogSyncService, PrismaCompanyRoleRepository, deriveModuleBundlesFromPermissions(), CreateCompanyRoleUseCase, DeleteCompanyRoleUseCase, GetCompanyRoleUseCase, ListCompanyRolesUseCase, UpdateCompanyRoleUseCase
...
Cohesion: 0.04
Nodes (46): 2026-05-20 (Wed) — Phase C (sales finance & reporting), 2026-05-22 (Fri) — Phase D.5 sales-return enhancements, 2026-05-22 (Fri) — Phase D.7 invoice templates (controlled model), 2026-05-22 (Fri) — Phase D.8 outbound messaging (WhatsApp-first), 2026-05-22 (Fri) — Phase D hardening audit (D.3 + D.4), 2026-05-23 (Sat) — D.8 follow-up: Telegram outbound execution, 2026-05-23 (Sat) — D.8 hardening: true multi-tenant messaging accounts, 2026-05-23 (Sat) — Phase D.6 invoice attachments (+38 more)
...
Cohesion: 0.11
Nodes (15): SuperAdminHeader(), SuperAdminPage(), SuperAdminPanel(), SuperAdminStatCard(), SuperAdminTable(), useSuperAdminTable(), handleSave(), update() (+7 more)
...
Cohesion: 0.06
Nodes (9): CostCenterMapper, PrismaCostCenterRepository, CostCenter, ActivateCostCenterUseCase, CreateCostCenterUseCase, DeactivateCostCenterUseCase, DeleteCostCenterUseCase, ListCostCentersUseCase (+1 more)
...
Cohesion: 0.09
Nodes (6): AccountAccessPolicy, ApprovalRequiredPolicy, CostCenterRequiredPolicy, PeriodLockPolicy, PrismaAccountLookupService, PrismaUserAccessScopeProvider
...
Cohesion: 0.08
Nodes (19): ItemMasterCard(), handleAutoGenerateCode(), handleSave(), loadParty(), renderPartyAccountCode(), zeroPad(), WarehouseMasterCard(), useRBAC() (+11 more)
...
Cohesion: 0.05
Nodes (40): 2026-05-12 Result — AI Assistant Fixing Plan Phase 1 Business Model Fix, 2026-05-12 Result — AI Assistant Fixing Plan Phase 2 Security Hardening, 2026-05-13 Result — Frontend Conversation History Sidebar, 2026-05-13 Result — Phase 6.6B Setup Wizard Integration, Changes, Changes, Changes, Changes (+32 more)
...
Cohesion: 0.1
Nodes (7): ExchangeRate, GetSuggestedRateUseCase, SaveReferenceRateUseCase, DisableCurrencyForCompanyUseCase, EnableCurrencyForCompanyUseCase, ListCompanyCurrenciesUseCase, SetExchangeRateUseCase
...
Cohesion: 0.1
Nodes (5): DeactivateAccountUseCase, DeleteAccountUseCase, GetAccountUseCase, ListAccountsUseCase, UpdateAccountUseCase

### Community 123 - "Community 123"
Cohesion: 0.12
Nodes (6): MockHttpClient, ProviderAuthError, ProviderError, ProviderRateLimitError, ProviderUnavailableError, AiPlatformApiKeyUseCase
...
Cohesion: 0.11
Nodes (15): VoucherPostingStrategyFactory, ApproveVoucherUseCase, buildFormData(), buildSourcePayload(), deepMergeObjects(), DeleteVoucherUseCase, GetVoucherUseCase, isPlainObject() (+7 more)
...
Cohesion: 0.11
Nodes (10): errorHandler(), getProviderErrorStatus(), getStatusCode(), isFirestoreTransactionError(), PeriodLockedError, PrismaAccountingPolicyConfigProvider, verifyProductionHardening(), PeriodLockService (+2 more)
...
Cohesion: 0.13
Nodes (8): CreateAccountUseCase, renderPartyAccountCode(), templateUsesSequence(), ZERO_PAD(), CreatePartyUseCase, GetPartyUseCase, ListPartiesUseCase, UpdatePartyUseCase
...
Cohesion: 0.1
Nodes (5): PurchasePriceList, CreatePurchasePriceListUseCase, DeletePurchasePriceListUseCase, GetEffectivePurchasePriceUseCase, GetPurchasePriceListUseCase

### Community 150 - "Community 150"
Cohesion: 0.09
Nodes (6): PriceList, CreatePriceListUseCase, GetEffectivePriceUseCase, GetPriceListUseCase, ListPriceListsUseCase, UpdatePriceListUseCase
...
Cohesion: 0.08
Nodes (8): GetCommissionEntryUseCase, ListCommissionsUseCase, GetCustomerGroupUseCase, ListCustomerGroupsUseCase, DeletePriceListUseCase, CreateSalespersonUseCase, ListSalespersonsUseCase, UpdateSalespersonUseCase
...
Cohesion: 0.11
Nodes (3): DataTableToolbar(), getBreakpointMaxPriority(), useResponsiveColumns()
...
Cohesion: 0.12
Nodes (3): FirestoreAiUsageLogRepository, PrismaAiUsageLogRepository, AiUsageLog
...
Cohesion: 0.1
Nodes (6): Permission, AuditLogMapper, ModuleMapper, NotificationMapper, RoleMapper, PrismaPermissionRepository

### Community 215 - "Community 215"
Cohesion: 0.12
Nodes (3): Salesperson, DeleteSalespersonUseCase, GetSalespersonUseCase

### Community 216 - "Community 216"
Cohesion: 0.11
Nodes (6): CommissionEntry, roundMoney(), AccrueCommissionForInvoiceUseCase, CancelCommissionUseCase, GetSalespersonCommissionTotalsUseCase, MarkCommissionPaidUseCase
...
Cohesion: 0.15
Nodes (17): buildPayload(), createEmptyForm(), createEmptyLine(), fromQuoteDTO(), handleAccept(), handleConvertToInvoice(), handleConvertToOrder(), handleReject() (+9 more)
...
Cohesion: 0.13
Nodes (5): Role, FirestoreAuditLogRepository, FirestorePermissionRepository, CreateRoleUseCase, UpdateRolePermissionsUseCase
...
Cohesion: 0.11
Nodes (3): fetchBalance(), loadSettings(), resolvePresetId()
...
Cohesion: 0.16
Nodes (4): AiAssistantDTOMapper, certificationCategoryForModule(), AiSettingsUseCase, ExecuteAiToolUseCase
...
Cohesion: 0.12
Nodes (16): Activate or deactivate a form, Add a custom form from scratch, Available Types, Clone a locked default to customise it, Common tasks, Concepts in one paragraph, Export a form as JSON, Forms Management (+8 more)
...
Cohesion: 0.12
Nodes (16): code:markdown (### [Module] — [Feature Name]), ERP03 — QA Queue, ❌ Failed — Needs Fix, Forms Management — Field Library Phase C1, 📝 How agents add items, Purchases — Phase F: Purchase Invoice Attachments, Purchases — Phase F: Purchase Price Lists, Purchases — Phase F: Vendor Groups (+8 more)
...
Cohesion: 0.12
Nodes (5): ListPurchasePriceListsUseCase, UpdatePurchasePriceListUseCase, GetVendorGroupUseCase, ListVendorGroupsUseCase, UpdateVendorGroupUseCase
...
Cohesion: 0.16
Nodes (6): applyOffsetLimit(), CreateTaxCodeUseCase, GetTaxCodeUseCase, ListTaxCodesUseCase, UpdateTaxCodeUseCase, validateRateConsistency()
...
Cohesion: 0.17
Nodes (6): handleDelete(), handleSubmit(), loadDomains(), handleDelete(), handleSubmit(), loadPlans()

### Community 403 - "Community 403"
Cohesion: 0.15
Nodes (5): buildBody(), handleSave(), handleSaved(), load(), load()
...
Cohesion: 0.22
Nodes (4): AccountingEngineUnavailableError, formatMessage(), EnsureAccountingEngineInitialized, InitializeAccountingUseCase

### Community 429 - "Community 429"
Cohesion: 0.15
Nodes (3): DetectRateDeviationService, GetCurrencyUseCase, ListCurrenciesUseCase
...
Cohesion: 0.15
Nodes (11): 1. Final Recommendation, 4. Line-Level Quantity Model, 9. V1 Scope Recommendation, Assumptions (flagged for review), code:block5 (┌─────────────────────────────────────────────────────────┐), ❌ Deferred to V2+, ✅ Definitely V1, Key invariants (+3 more)
...
Cohesion: 0.24
Nodes (4): checkFormDeletable(), toggleFormEnabled(), FirestoreIdempotencyKeyRepository, toTimestamp()

### Community 522 - "Community 522"
Cohesion: 0.2
Nodes (5): AiStreamError, parseSSEEvent(), streamMessage(), getAuthToken(), getCompanyId()
...
Cohesion: 0.2
Nodes (3): GetBalanceSheetTool, GetProfitAndLossTool, GetUsageAnalyticsUseCase
...
Cohesion: 0.18
Nodes (9): 10. Item Extension for Sales Accounts, 6.1 Company-Level Sales Settings, 6. Settings Design, 8. Shared Services Reuse, 9. V1 Scope, code:typescript (// ADD to existing ItemProps:), ❌ Deferred, ✅ Definitely V1 (+1 more)
...
Cohesion: 0.18
Nodes (9): code:typescript (const mockModelProfileUseCase = {), D1. `CheckProviderHealthUseCase.test.ts` — Constructor needs 4 args (3 files), D2. `AiModelCertificationUseCase.test.ts` — Constructor needs 6 args, D3. `AiRuntimeGuard.test.ts` — Model profile status assertion, D4. `SendChatMessageUseCase.test.ts` — 2 failures, D5. `ConfigureInventoryFinancialIntegrationUseCase.test.ts` — Missing mock method, D6. `AccountingBoundary.test.ts` — Architecture boundary drift, D7. `real-provider-smoke.test.ts` — Integration test (skip if no provider) (+1 more)

### Community 615 - "Community 615"
Cohesion: 0.18
Nodes (10): Action, After This Task, code:bash (git add -A), Problem, Problem, Subtask D — Fix 9 Pre-existing Test Failures (1-2h), Subtask F — Commit Remaining Uncommitted Files (15min), Task 94 — AI Module Finalization (+2 more)
...
Cohesion: 0.25
Nodes (8): code:block2 (// 4. Run Behavioral Tests (if provider available and deep p), Current state, Files to modify, Fix, Implementation details, Problem, Subtask C — Wire Behavioral Test Suite into Certification Engine (3-4h), Verification
...
Cohesion: 0.52
Nodes (6): handleCreate(), handleDelete(), handleUpdate(), handleValidate(), refresh(), unwrap()
...
Cohesion: 0.29
Nodes (7): code:typescript (const toolMappings = getExecutableDefinitions()), Files to modify, Fix, Implementation details, Problem, Subtask A — MockProvider: Use DB keywords instead of hardcoded (1-2h), Verification
...
Cohesion: 0.33
Nodes (5): AI Assistant Chat Sidebar, How to Use, Languages, Technical Notes, What It Does
...
Cohesion: 0.33
Nodes (6): code:typescript (if (runtimeMode === 'CREDITS') {), Files to modify, Implementation details, Problem, Subtask E — Streaming Credit Pre-check (30min), Verification

### Community 905 - "Community 905"
Cohesion: 0.33
Nodes (6): Files to modify, Fix, Implementation details, Problem, Subtask B — Super Admin Credits UI (2-3h), Verification
...
## Knowledge Gaps
- **6335 isolated node(s):** `MockHttpClient`, `MANDATORY FIRST STEP — READ BEFORE DOING ANYTHING`, `DEFINITION OF DONE — EVERY FEATURE`, `Your Role: You Are the CTO`, `1. Session Start Protocol` (+6330 more)
...
- **Why does `Account` connect `Community 84` to `Community 2`, `Community 424`, `Community 14`, `Community 122`, `Community 31`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `NewVoucherFormsDemo()` connect `Community 14` to `Community 84`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `useCompanyAccess()` connect `Community 14` to `Community 32`, `Community 3`, `Community 35`, `Community 6`, `Community 8`, `Community 9`, `Community 42`, `Community 136`, `Community 12`, `Community 13`, `Community 206`, `Community 79`, `Community 49`, `Community 50`, `Community 17`, `Community 372`, `Community 21`, `Community 26`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Are the 532 inferred relationships involving `Next` (e.g. with `.getByEntity()` and `.list()`) actually correct?**
  _`Next` has 532 INFERRED edges - model-reasoned connections that need verification._
